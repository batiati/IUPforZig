...
pub const FontDlg = opaque {
    ...
    pub const Initializer = struct {
        ...
        /// 
        /// COLOR [Windows Only]: The initial color value and the returned selected
        /// value if the user pressed the Ok button.
        /// In Windows the Choose Font dialog allows the user to select a color from a
    ...
    pub fn getStatus(self: *Self) i32 {
        return c.getIntAttribute(self, "STATUS", void, void);
    }
...
test "FontDlg TipBalloon" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FontDlg.init().setTipBalloon(true).unwrap());
    defer item.deinit();
...
test "FontDlg TrayTipBalloonTitleIcon" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FontDlg.init().setTrayTipBalloonTitleIcon(42).unwrap());
    defer item.deinit();
...
test "FontDlg MaximizeAtParent" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FontDlg.init().setMaximizeAtParent(true).unwrap());
    defer item.deinit();
...
test "FontDlg CustomFrameDraw" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FontDlg.init().setCustomFrameDraw(true).unwrap());
    defer item.deinit();
...
test "FontDlg Cursor" {
    ...
    var item = try (iup.FontDlg.init().setCursor("Hello").unwrap());
    defer item.deinit();
...
test "FontDlg ShowMinimizeNext" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FontDlg.init().setShowMinimizeNext(true).unwrap());
    defer item.deinit();
...
test "FontDlg TrayTipBalloonTitle" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FontDlg.init().setTrayTipBalloonTitle("Hello").unwrap());
    defer item.deinit();
...
test "FontDlg DragCursorCopy" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FontDlg.init().setDragCursorCopy("Hello").unwrap());
    defer item.deinit();
...
test "FontDlg TaskbarProgress" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FontDlg.init().setTaskbarProgress(42).unwrap());
    defer item.deinit();
...
test "FontDlg MdiMenu" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FontDlg.init().setMdiMenu("Hello").unwrap());
    defer item.deinit();
...
test "FontDlg TrayTipDelay" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FontDlg.init().setTrayTipDelay(42).unwrap());
    defer item.deinit();
...
test "FontDlg CustomFrameCaptionLimits" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FontDlg.init().setCustomFrameCaptionLimits(9, 10).unwrap());
    defer item.deinit();
...
test "FontDlg DragStart" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FontDlg.init().setDragStart(9, 10).unwrap());
    defer item.deinit();
...
test "FontDlg LayerAlpha" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FontDlg.init().setLayerAlpha(42).unwrap());
    defer item.deinit();
...
test "FontDlg TipBalloonTitle" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FontDlg.init().setTipBalloonTitle("Hello").unwrap());
    defer item.deinit();
...
test "FontDlg TrayTipBalloon" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FontDlg.init().setTrayTipBalloon(true).unwrap());
    defer item.deinit();
...
test "FontDlg Color" {
    ...
    var item = try (iup.FontDlg.init().setColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FontDlg ControlId" {
    ...
    var item = try (iup.FontDlg.init().setControlId(42).unwrap());
    defer item.deinit();
...
test "FontDlg ShowNoActivate" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FontDlg.init().setShowNoActivate(true).unwrap());
    defer item.deinit();
...
test "FontDlg MaximizeAtDialog" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FontDlg.init().setMaximizeAtDialog(true).unwrap());
    defer item.deinit();
...
test "FontDlg TaskbarButton" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FontDlg.init().setTaskbarButton(.Show).unwrap());
    defer item.deinit();
...
test "FontDlg TipBalloonTitleIcon" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FontDlg.init().setTipBalloonTitleIcon(true).unwrap());
    defer item.deinit();
...
test "FontDlg TrayImage" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FontDlg.init().setTrayImage("Hello").unwrap());
    defer item.deinit();
...
test "FontDlg CustomFrameCaptionHeight" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FontDlg.init().setCustomFrameCaptionHeight(42).unwrap());
    defer item.deinit();
...
test "FontDlg Touch" {
    ...
    var item = try (iup.FontDlg.init().setTouch(true).unwrap());
    defer item.deinit();
...
test "FontDlg MaximizedIalog" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FontDlg.init().setMaximizedIalog("Hello").unwrap());
    defer item.deinit();
...
test "FontDlg DragCursor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FontDlg.init().setDragCursor("Hello").unwrap());
    defer item.deinit();
