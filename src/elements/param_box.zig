...
/// in a vertical composition.
/// It does not have a native representation.
pub const ParamBox = opaque {
    pub const CLASS_NAME = "parambox";
    const Self = @This();
    ...
    pub const Initializer = struct {
        ...
        pub fn setUserData(self: *Initializer, comptime T: type, arg: ?*T) Initializer {
            c.setPtrAttribute(T, self.ref, "USERDATA", void, void, arg);
            return self.*;
        }
    ...
    pub fn getUserData(self: *Self, comptime T: type) ?*T {
        return c.getPtrAttribute(T, self, "USERDATA", void, void);
    }
    ...
    pub fn setUserData(self: *Self, comptime T: type, arg: ?*T) void {
        c.setPtrAttribute(T, self, "USERDATA", void, void, arg);
    }
