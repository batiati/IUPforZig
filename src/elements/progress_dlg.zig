...
pub const ProgressDlg = opaque {
    ...
    pub const Initializer = struct {
        ...
        pub fn setState(self: *Initializer, arg: ?State) Initializer {
            if (arg) |value| switch (value) {
                .Aborted => interop.setStrAttribute(self.ref, "STATE", .{}, "ABORTED"),
                .Processing => interop.setStrAttribute(self.ref, "STATE", .{}, "PROCESSING"),
                .Undefined => interop.setStrAttribute(self.ref, "STATE", .{}, "UNDEFINED"),
                .Idle => interop.setStrAttribute(self.ref, "STATE", .{}, "IDLE"),
            } else {
    ...
    pub fn setState(self: *Self, arg: ?State) void {
        if (arg) |value| switch (value) {
            .Aborted => interop.setStrAttribute(self, "STATE", .{}, "ABORTED"),
            .Processing => interop.setStrAttribute(self, "STATE", .{}, "PROCESSING"),
            .Undefined => interop.setStrAttribute(self, "STATE", .{}, "UNDEFINED"),
            .Idle => interop.setStrAttribute(self, "STATE", .{}, "IDLE"),
        } else {
