...
pub const ProgressDlg = opaque {
    ...
    pub const Initializer = struct {
        ...
        pub fn setState(self: *Initializer, arg: ?State) Initializer {
            if (arg) |value| switch (value) {
                ...
                .Processing => c.setStrAttribute(self.ref, "STATE", "PROCESSING"),
                .Undefined => c.setStrAttribute(self.ref, "STATE", "UNDEFINED"),
                .Idle => c.setStrAttribute(self.ref, "STATE", "IDLE"),
            } else {
    ...
    pub fn setState(self: *Self, arg: ?State) void {
        if (arg) |value| switch (value) {
            ...
            .Processing => c.setStrAttribute(self, "STATE", "PROCESSING"),
            .Undefined => c.setStrAttribute(self, "STATE", "UNDEFINED"),
            .Idle => c.setStrAttribute(self, "STATE", "IDLE"),
        } else {
