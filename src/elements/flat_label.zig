...
/// It behaves just like an IupLabel, but since it is not a native control it
/// has more flexibility for additional options.
/// It inherits from IupCanvas.
pub const FlatLabel = opaque {
    pub const CLASS_NAME = "flatlabel";
    const Self = @This();
...
test "FlatLabel FgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setFgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatLabel TipBalloon" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setTipBalloon(true).unwrap());
    defer item.deinit();
...
test "FlatLabel HandleName" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setHandleName("Hello").unwrap());
    defer item.deinit();
...
test "FlatLabel TipBgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setTipBgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatLabel XMin" {
    ...
    var item = try (iup.FlatLabel.init().setXMin(42).unwrap());
    defer item.deinit();
...
test "FlatLabel MaxSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setMaxSize(9, 10).unwrap());
    defer item.deinit();
...
test "FlatLabel DrawTextWrap" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setDrawTextWrap(true).unwrap());
    defer item.deinit();
...
test "FlatLabel DrawUsedIRect2d" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setDrawUsedIRect2d(true).unwrap());
    defer item.deinit();
...
test "FlatLabel Position" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setPosition(9, 10).unwrap());
    defer item.deinit();
...
test "FlatLabel DropFilesTarget" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setDropFilesTarget(true).unwrap());
    defer item.deinit();
...
test "FlatLabel DrawTextAlignment" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setDrawTextAlignment(.ACenter).unwrap());
    defer item.deinit();
...
test "FlatLabel Tip" {
    ...
    var item = try (iup.FlatLabel.init().setTip("Hello").unwrap());
    defer item.deinit();
...
test "FlatLabel DrawTextLayoutCenter" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setDrawTextLayoutCenter(true).unwrap());
    defer item.deinit();
...
test "FlatLabel CanFocus" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setCanFocus(true).unwrap());
    defer item.deinit();
...
test "FlatLabel DragSourceMove" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setDragSourceMove(true).unwrap());
    defer item.deinit();
...
test "FlatLabel Visible" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setVisible(true).unwrap());
    defer item.deinit();
...
test "FlatLabel Image" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setImage("Hello").unwrap());
    defer item.deinit();
...
test "FlatLabel LineX" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setLineX(3.14).unwrap());
    defer item.deinit();
...
test "FlatLabel Cursor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setCursor("Hello").unwrap());
    defer item.deinit();
...
test "FlatLabel LineY" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setLineY(3.14).unwrap());
    defer item.deinit();
...
test "FlatLabel DrawLineWidth" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setDrawLineWidth(42).unwrap());
    defer item.deinit();
...
test "FlatLabel DragDrop" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setDragDrop(true).unwrap());
    defer item.deinit();
...
test "FlatLabel DrawAntialias" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setDrawAntialias(42).unwrap());
    defer item.deinit();
...
test "FlatLabel Theme" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setTheme("Hello").unwrap());
    defer item.deinit();
...
test "FlatLabel DragCursorCopy" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setDragCursorCopy("Hello").unwrap());
    defer item.deinit();
...
test "FlatLabel HtTransparent" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setHtTransparent(true).unwrap());
    defer item.deinit();
...
test "FlatLabel Expand" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setExpand(.Yes).unwrap());
    defer item.deinit();
...
test "FlatLabel DrawFont" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setDrawFont("Hello").unwrap());
    defer item.deinit();
...
test "FlatLabel Size" {
    ...
    var item = try (iup.FlatLabel.init().setSize(9, 10).unwrap());
    defer item.deinit();
...
test "FlatLabel Padding" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setPadding(9, 10).unwrap());
    defer item.deinit();
...
test "FlatLabel PosX" {
    ...
    var item = try (iup.FlatLabel.init().setPosX(3.14).unwrap());
    defer item.deinit();
...
test "FlatLabel PosY" {
    ...
    var item = try (iup.FlatLabel.init().setPosY(3.14).unwrap());
    defer item.deinit();
...
test "FlatLabel YMin" {
    ...
    var item = try (iup.FlatLabel.init().setYMin(42).unwrap());
    defer item.deinit();
...
test "FlatLabel TextEllipsis" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setTextEllipsis(true).unwrap());
    defer item.deinit();
...
test "FlatLabel DrawMakeInactive" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setDrawMakeInactive(true).unwrap());
    defer item.deinit();
...
test "FlatLabel FontSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setFontSize(42).unwrap());
    defer item.deinit();
...
test "FlatLabel DropTypes" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setDropTypes("Hello").unwrap());
    defer item.deinit();
...
test "FlatLabel UserSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setUserSize(9, 10).unwrap());
    defer item.deinit();
...
test "FlatLabel TipDelay" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setTipDelay(42).unwrap());
    defer item.deinit();
...
test "FlatLabel ScrollBar" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setScrollBar(true).unwrap());
    defer item.deinit();
...
test "FlatLabel DragStart" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setDragStart(9, 10).unwrap());
    defer item.deinit();
...
test "FlatLabel Title" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setTitle("Hello").unwrap());
    defer item.deinit();
...
test "FlatLabel XAutoHide" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setXAutoHide(true).unwrap());
    defer item.deinit();
...
test "FlatLabel PropagateFocus" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setPropagateFocus(true).unwrap());
    defer item.deinit();
...
test "FlatLabel XMax" {
    ...
    var item = try (iup.FlatLabel.init().setXMax(42).unwrap());
    defer item.deinit();
...
test "FlatLabel BgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setBgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatLabel TipBalloonTitle" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setTipBalloonTitle("Hello").unwrap());
    defer item.deinit();
...
test "FlatLabel DropTarget" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setDropTarget(true).unwrap());
    defer item.deinit();
...
test "FlatLabel DX" {
    ...
    var item = try (iup.FlatLabel.init().setDX(3.14).unwrap());
    defer item.deinit();
...
test "FlatLabel DY" {
    ...
    var item = try (iup.FlatLabel.init().setDY(3.14).unwrap());
    defer item.deinit();
...
test "FlatLabel DrawTextEllipsis" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setDrawTextEllipsis(true).unwrap());
    defer item.deinit();
...
test "FlatLabel DragSource" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setDragSource(true).unwrap());
    defer item.deinit();
...
test "FlatLabel DrawTextClip" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setDrawTextClip(true).unwrap());
    defer item.deinit();
...
test "FlatLabel Floating" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setFloating(.Yes).unwrap());
    defer item.deinit();
...
test "FlatLabel NormalizerGroup" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setNormalizerGroup("Hello").unwrap());
    defer item.deinit();
...
test "FlatLabel Spacing" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setSpacing(42).unwrap());
    defer item.deinit();
...
test "FlatLabel RasterSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setRasterSize(9, 10).unwrap());
    defer item.deinit();
...
test "FlatLabel TipFgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setTipFgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatLabel ControlId" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setControlId(42).unwrap());
    defer item.deinit();
...
test "FlatLabel CSpacing" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setCSpacing(42).unwrap());
    defer item.deinit();
...
test "FlatLabel FrontImage" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setFrontImage("Hello").unwrap());
    defer item.deinit();
...
test "FlatLabel FontFace" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setFontFace("Hello").unwrap());
    defer item.deinit();
...
test "FlatLabel DrawColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setDrawColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatLabel DrawTextOrientation" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setDrawTextOrientation(3.14).unwrap());
    defer item.deinit();
...
test "FlatLabel DrawBgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setDrawBgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatLabel Name" {
    ...
    var item = try (iup.FlatLabel.init().setName("Hello").unwrap());
    defer item.deinit();
...
test "FlatLabel BackingStore" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setBackingStore(true).unwrap());
    defer item.deinit();
...
test "FlatLabel TipBalloonTitleIcon" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setTipBalloonTitleIcon(true).unwrap());
    defer item.deinit();
...
test "FlatLabel YAutoHide" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setYAutoHide(true).unwrap());
    defer item.deinit();
...
test "FlatLabel DrawStyle" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setDrawStyle(.Fill).unwrap());
    defer item.deinit();
...
test "FlatLabel BackImageZoom" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setBackImageZoom(true).unwrap());
    defer item.deinit();
...
test "FlatLabel CPadding" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setCPadding(9, 10).unwrap());
    defer item.deinit();
...
test "FlatLabel TextOrientation" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setTextOrientation(3.14).unwrap());
    defer item.deinit();
...
test "FlatLabel FitToBackImage" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setFitToBackImage(true).unwrap());
    defer item.deinit();
...
test "FlatLabel Active" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setActive(true).unwrap());
    defer item.deinit();
...
test "FlatLabel TipVisible" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setTipVisible(true).unwrap());
    defer item.deinit();
...
test "FlatLabel YMax" {
    ...
    var item = try (iup.FlatLabel.init().setYMax(42).unwrap());
    defer item.deinit();
...
test "FlatLabel BackImage" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setBackImage("Hello").unwrap());
    defer item.deinit();
...
test "FlatLabel ExpandWeight" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setExpandWeight(3.14).unwrap());
    defer item.deinit();
...
test "FlatLabel MinSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setMinSize(9, 10).unwrap());
    defer item.deinit();
...
test "FlatLabel NTheme" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setNTheme("Hello").unwrap());
    defer item.deinit();
...
test "FlatLabel ImagePosition" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setImagePosition(.Left).unwrap());
    defer item.deinit();
...
test "FlatLabel DragTypes" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setDragTypes("Hello").unwrap());
    defer item.deinit();
...
test "FlatLabel WheelDropFocus" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setWheelDropFocus(true).unwrap());
    defer item.deinit();
...
test "FlatLabel FontStyle" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setFontStyle("Hello").unwrap());
    defer item.deinit();
...
test "FlatLabel TextAlignment" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setTextAlignment(.ARight).unwrap());
    defer item.deinit();
...
test "FlatLabel Touch" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setTouch(true).unwrap());
    defer item.deinit();
...
test "FlatLabel TextWrap" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setTextWrap(true).unwrap());
    defer item.deinit();
...
test "FlatLabel DragCursor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatLabel.init().setDragCursor("Hello").unwrap());
    defer item.deinit();
...
test "FlatLabel Font" {
    ...
    var item = try (iup.FlatLabel.init().setFont("Hello").unwrap());
    defer item.deinit();
