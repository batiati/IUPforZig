...
/// It behaves just like an IupButton, but since it is not a native control it
...
pub const FlatButton = opaque {
    pub const CLASS_NAME = "flatbutton";
    const Self = @This();
    ...
    pub const Initializer = struct {
        ...
        /// Valid only when TOGGLE=Yes.
        /// Can only be set to ON for a toggle inside a radio, it will automatically
        /// set to OFF the previous toggle that was ON.
...
test "FlatButton FgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setFgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatButton TipBalloon" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setTipBalloon(true).unwrap());
    defer item.deinit();
...
test "FlatButton HandleName" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setHandleName("Hello").unwrap());
    defer item.deinit();
...
test "FlatButton TipBgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setTipBgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatButton XMin" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setXMin(42).unwrap());
    defer item.deinit();
...
test "FlatButton MaxSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setMaxSize(9, 10).unwrap());
    defer item.deinit();
...
test "FlatButton DrawTextWrap" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setDrawTextWrap(true).unwrap());
    defer item.deinit();
...
test "FlatButton DrawUsedIRect2d" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setDrawUsedIRect2d(true).unwrap());
    defer item.deinit();
...
test "FlatButton FocusFeedback" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setFocusFeedback(true).unwrap());
    defer item.deinit();
...
test "FlatButton Position" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setPosition(9, 10).unwrap());
    defer item.deinit();
...
test "FlatButton DropFilesTarget" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setDropFilesTarget(true).unwrap());
    defer item.deinit();
...
test "FlatButton DrawTextAlignment" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setDrawTextAlignment(.ACenter).unwrap());
    defer item.deinit();
...
test "FlatButton Tip" {
    ...
    var item = try (iup.FlatButton.init().setTip("Hello").unwrap());
    defer item.deinit();
...
test "FlatButton DrawTextLayoutCenter" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setDrawTextLayoutCenter(true).unwrap());
    defer item.deinit();
...
test "FlatButton DragSourceMove" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setDragSourceMove(true).unwrap());
    defer item.deinit();
...
test "FlatButton PsColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setPsColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatButton Visible" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setVisible(true).unwrap());
    defer item.deinit();
...
test "FlatButton Image" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setImage("Hello").unwrap());
    defer item.deinit();
...
test "FlatButton LineX" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setLineX(3.14).unwrap());
    defer item.deinit();
...
test "FlatButton Cursor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setCursor("Hello").unwrap());
    defer item.deinit();
...
test "FlatButton LineY" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setLineY(3.14).unwrap());
    defer item.deinit();
...
test "FlatButton DrawLineWidth" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setDrawLineWidth(42).unwrap());
    defer item.deinit();
...
test "FlatButton DragDrop" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setDragDrop(true).unwrap());
    defer item.deinit();
...
test "FlatButton DrawAntialias" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setDrawAntialias(42).unwrap());
    defer item.deinit();
...
test "FlatButton Theme" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setTheme("Hello").unwrap());
    defer item.deinit();
...
test "FlatButton DragCursorCopy" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setDragCursorCopy("Hello").unwrap());
    defer item.deinit();
...
test "FlatButton HtTransparent" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setHtTransparent(true).unwrap());
    defer item.deinit();
...
test "FlatButton Expand" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setExpand(.Yes).unwrap());
    defer item.deinit();
...
test "FlatButton DrawFont" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setDrawFont("Hello").unwrap());
    defer item.deinit();
...
test "FlatButton Size" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setSize(9, 10).unwrap());
    defer item.deinit();
...
test "FlatButton Padding" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setPadding(9, 10).unwrap());
    defer item.deinit();
...
test "FlatButton PosX" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setPosX(3.14).unwrap());
    defer item.deinit();
...
test "FlatButton PosY" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setPosY(3.14).unwrap());
    defer item.deinit();
...
test "FlatButton BorderHlColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setBorderHlColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatButton TextHlColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setTextHlColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatButton YMin" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setYMin(42).unwrap());
    defer item.deinit();
...
test "FlatButton TextEllipsis" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setTextEllipsis(true).unwrap());
    defer item.deinit();
...
test "FlatButton DrawMakeInactive" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setDrawMakeInactive(true).unwrap());
    defer item.deinit();
...
test "FlatButton FontSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setFontSize(42).unwrap());
    defer item.deinit();
...
test "FlatButton DropTypes" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setDropTypes("Hello").unwrap());
    defer item.deinit();
...
test "FlatButton UserSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setUserSize(9, 10).unwrap());
    defer item.deinit();
...
test "FlatButton TipDelay" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setTipDelay(42).unwrap());
    defer item.deinit();
...
test "FlatButton ScrollBar" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setScrollBar(true).unwrap());
    defer item.deinit();
...
test "FlatButton DragStart" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setDragStart(9, 10).unwrap());
    defer item.deinit();
...
test "FlatButton Title" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setTitle("Hello").unwrap());
    defer item.deinit();
...
test "FlatButton XAutoHide" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setXAutoHide(true).unwrap());
    defer item.deinit();
...
test "FlatButton PropagateFocus" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setPropagateFocus(true).unwrap());
    defer item.deinit();
...
test "FlatButton XMax" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setXMax(42).unwrap());
    defer item.deinit();
...
test "FlatButton BgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setBgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatButton TipBalloonTitle" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setTipBalloonTitle("Hello").unwrap());
    defer item.deinit();
...
test "FlatButton DropTarget" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setDropTarget(true).unwrap());
    defer item.deinit();
...
test "FlatButton DX" {
    ...
    var item = try (iup.FlatButton.init().setDX(3.14).unwrap());
    defer item.deinit();
...
test "FlatButton DY" {
    ...
    var item = try (iup.FlatButton.init().setDY(3.14).unwrap());
    defer item.deinit();
...
test "FlatButton DrawTextEllipsis" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setDrawTextEllipsis(true).unwrap());
    defer item.deinit();
...
test "FlatButton DragSource" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setDragSource(true).unwrap());
    defer item.deinit();
...
test "FlatButton DrawTextClip" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setDrawTextClip(true).unwrap());
    defer item.deinit();
...
test "FlatButton Floating" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setFloating(.Yes).unwrap());
    defer item.deinit();
...
test "FlatButton NormalizerGroup" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setNormalizerGroup("Hello").unwrap());
    defer item.deinit();
...
test "FlatButton Spacing" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setSpacing(42).unwrap());
    defer item.deinit();
...
test "FlatButton BorderPsColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setBorderPsColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatButton RasterSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setRasterSize(9, 10).unwrap());
    defer item.deinit();
...
test "FlatButton TextPsColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setTextPsColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatButton BorderColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setBorderColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatButton TipFgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setTipFgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatButton ControlId" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setControlId(42).unwrap());
    defer item.deinit();
...
test "FlatButton CSpacing" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setCSpacing(42).unwrap());
    defer item.deinit();
...
test "FlatButton HlColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setHlColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatButton FrontImage" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setFrontImage("Hello").unwrap());
    defer item.deinit();
...
test "FlatButton FontFace" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setFontFace("Hello").unwrap());
    defer item.deinit();
...
test "FlatButton DrawColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setDrawColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatButton DrawTextOrientation" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setDrawTextOrientation(3.14).unwrap());
    defer item.deinit();
...
test "FlatButton DrawBgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setDrawBgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatButton Name" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setName("Hello").unwrap());
    defer item.deinit();
...
test "FlatButton BackingStore" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setBackingStore(true).unwrap());
    defer item.deinit();
...
test "FlatButton TipBalloonTitleIcon" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setTipBalloonTitleIcon(true).unwrap());
    defer item.deinit();
...
test "FlatButton YAutoHide" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setYAutoHide(true).unwrap());
    defer item.deinit();
...
test "FlatButton DrawStyle" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setDrawStyle(.Fill).unwrap());
    defer item.deinit();
...
test "FlatButton Value" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setValue("Hello").unwrap());
    defer item.deinit();
...
test "FlatButton BackImageZoom" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setBackImageZoom(true).unwrap());
    defer item.deinit();
...
test "FlatButton CPadding" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setCPadding(9, 10).unwrap());
    defer item.deinit();
...
test "FlatButton TextOrientation" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setTextOrientation(3.14).unwrap());
    defer item.deinit();
...
test "FlatButton FitToBackImage" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setFitToBackImage(true).unwrap());
    defer item.deinit();
...
test "FlatButton Active" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setActive(true).unwrap());
    defer item.deinit();
...
test "FlatButton TipVisible" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setTipVisible(true).unwrap());
    defer item.deinit();
...
test "FlatButton ImageHighlight" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setImageHighlight("Hello").unwrap());
    defer item.deinit();
...
test "FlatButton YMax" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setYMax(42).unwrap());
    defer item.deinit();
...
test "FlatButton BackImage" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setBackImage("Hello").unwrap());
    defer item.deinit();
...
test "FlatButton ExpandWeight" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setExpandWeight(3.14).unwrap());
    defer item.deinit();
...
test "FlatButton MinSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setMinSize(9, 10).unwrap());
    defer item.deinit();
...
test "FlatButton ShowBorder" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setShowBorder(true).unwrap());
    defer item.deinit();
...
test "FlatButton NTheme" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setNTheme("Hello").unwrap());
    defer item.deinit();
...
test "FlatButton IgnoreRadio" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setIgnoreRadio(true).unwrap());
    defer item.deinit();
...
test "FlatButton ImagePosition" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setImagePosition(.Left).unwrap());
    defer item.deinit();
...
test "FlatButton DragTypes" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setDragTypes("Hello").unwrap());
    defer item.deinit();
...
test "FlatButton WheelDropFocus" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setWheelDropFocus(true).unwrap());
    defer item.deinit();
...
test "FlatButton BorderWidth" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setBorderWidth(42).unwrap());
    defer item.deinit();
...
test "FlatButton FontStyle" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setFontStyle("Hello").unwrap());
    defer item.deinit();
...
test "FlatButton TextAlignment" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setTextAlignment(.ARight).unwrap());
    defer item.deinit();
...
test "FlatButton Touch" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setTouch(true).unwrap());
    defer item.deinit();
...
test "FlatButton TextWrap" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setTextWrap(true).unwrap());
    defer item.deinit();
...
test "FlatButton DragCursor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setDragCursor("Hello").unwrap());
    defer item.deinit();
...
test "FlatButton Font" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatButton.init().setFont("Hello").unwrap());
    defer item.deinit();
