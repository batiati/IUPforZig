...
pub const HBox = opaque {
    ...
    pub const Initializer = struct {
        ...
        pub fn setAlignment(self: *Initializer, arg: ?Alignment) Initializer {
            if (arg) |value| switch (value) {
                .ABottom => c.setStrAttribute(self.ref, "ALIGNMENT", void, void, "ABOTTOM"),
                .ACenter => c.setStrAttribute(self.ref, "ALIGNMENT", void, void, "ACENTER"),
                .ATop => c.setStrAttribute(self.ref, "ALIGNMENT", void, void, "ATOP"),
            } else {
    ...
    pub fn setAlignment(self: *Self, arg: ?Alignment) void {
        if (arg) |value| switch (value) {
            .ABottom => c.setStrAttribute(self, "ALIGNMENT", void, void, "ABOTTOM"),
            .ACenter => c.setStrAttribute(self, "ALIGNMENT", void, void, "ACENTER"),
            .ATop => c.setStrAttribute(self, "ALIGNMENT", void, void, "ATOP"),
        } else {
