...
test "Tree TitleFontStyle" {
    ...
    var item = try (iup.Tree.init().setTitleFontStyle("Hello").unwrap());
    defer item.deinit();
...
test "Tree ToggleVisible" {
    ...
    var item = try (iup.Tree.init().setToggleVisible(true).unwrap());
    defer item.deinit();
...
test "Tree TitleFontSize" {
    ...
    var item = try (iup.Tree.init().setTitleFontSize(42).unwrap());
    defer item.deinit();
...
test "Tree Title" {
    ...
    var item = try (iup.Tree.init().setTitle("Hello").unwrap());
    defer item.deinit();
...
test "Tree Color" {
    ...
    var item = try (iup.Tree.init().setColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "Tree TitleFont" {
    ...
    var item = try (iup.Tree.init().setTitleFont("Hello").unwrap());
    defer item.deinit();
...
test "Tree State" {
    ...
    var item = try (iup.Tree.init().setState(.Expanded).unwrap());
    defer item.deinit();
...
test "Tree ToggleValue" {
    ...
    var item = try (iup.Tree.init().setToggleValue(.On).unwrap());
    defer item.deinit();
