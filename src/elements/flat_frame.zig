...
pub const FlatFrame = opaque {
    ...
    pub const Initializer = struct {
        ...
        pub fn setFrame(self: *Initializer, arg: ?Frame) Initializer {
            if (arg) |value| switch (value) {
                .Yes => c.setStrAttribute(self.ref, "FRAME", "YES"),
                .No => c.setStrAttribute(self.ref, "FRAME", "NO"),
                .CrossTitle => c.setStrAttribute(self.ref, "FRAME", "CROSSTITLE"),
            } else {
                c.clearAttribute(self.ref, "FRAME");
            }
            return self.*;
        }
    ...
    pub fn getFrame(self: *Self) ?Frame {
        var ret = c.getStrAttribute(self, "FRAME");
    ...
    pub fn setFrame(self: *Self, arg: ?Frame) void {
        if (arg) |value| switch (value) {
            .Yes => c.setStrAttribute(self, "FRAME", "YES"),
            .No => c.setStrAttribute(self, "FRAME", "NO"),
            .CrossTitle => c.setStrAttribute(self, "FRAME", "CROSSTITLE"),
        } else {
            c.clearAttribute(self, "FRAME");
        }
    }
