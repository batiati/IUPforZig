...
pub const FlatFrame = opaque {
    ...
    pub const Initializer = struct {
        ...
        pub fn setFrame(self: *Initializer, arg: ?Frame) Initializer {
            if (arg) |value| switch (value) {
                .Yes => interop.setStrAttribute(self.ref, "FRAME", .{}, "YES"),
                .No => interop.setStrAttribute(self.ref, "FRAME", .{}, "NO"),
                .CrossTitle => interop.setStrAttribute(self.ref, "FRAME", .{}, "CROSSTITLE"),
            } else {
                interop.clearAttribute(self.ref, "FRAME", .{});
            }
            return self.*;
        }
    ...
    pub fn getFrame(self: *Self) ?Frame {
        var ret = interop.getStrAttribute(self, "FRAME", .{});
    ...
    pub fn setFrame(self: *Self, arg: ?Frame) void {
        if (arg) |value| switch (value) {
            .Yes => interop.setStrAttribute(self, "FRAME", .{}, "YES"),
            .No => interop.setStrAttribute(self, "FRAME", .{}, "NO"),
            .CrossTitle => interop.setStrAttribute(self, "FRAME", .{}, "CROSSTITLE"),
        } else {
            interop.clearAttribute(self, "FRAME", .{});
        }
    }
