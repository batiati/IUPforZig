...
pub const MatrixList = opaque {
    ...
    pub const Initializer = struct {
        ...
        pub fn setListEditIOnCallback(self: *Initializer, callback: ?OnListEditIOnFn) Initializer {
        ...
        pub fn setListReleaseCallback(self: *Initializer, callback: ?OnListReleaseFn) Initializer {
        ...
        pub fn setListClickCallback(self: *Initializer, callback: ?OnListClickFn) Initializer {
        ...
        pub fn setListActionCallback(self: *Initializer, callback: ?OnListActionFn) Initializer {
        ...
        pub fn setImageValueChangedCallback(self: *Initializer, callback: ?OnImageValueChangedFn) Initializer {
            const Handler = CallbackHandler(Self, OnImageValueChangedFn, "IMAGEVALUECHANGED_CB");
            Handler.setCallback(self.ref, callback);
            return self.*;
        }

        pub fn setListRemoveCallback(self: *Initializer, callback: ?OnListRemoveFn) Initializer {
        ...
        pub fn setListInsertCallback(self: *Initializer, callback: ?OnListInsertFn) Initializer {
        ...
        pub fn setListDrawCallback(self: *Initializer, callback: ?OnListDrawFn) Initializer {
    ...
    pub fn setListEditIOnCallback(self: *Self, callback: ?OnListEditIOnFn) void {
        const Handler = CallbackHandler(Self, OnListEditIOnFn, "LISTEDITION_CB");
        Handler.setCallback(self, callback);
    }
    ...
    pub fn setListReleaseCallback(self: *Self, callback: ?OnListReleaseFn) void {
        const Handler = CallbackHandler(Self, OnListReleaseFn, "LISTRELEASE_CB");
        Handler.setCallback(self, callback);
    }
    ...
    pub fn setListClickCallback(self: *Self, callback: ?OnListClickFn) void {
        const Handler = CallbackHandler(Self, OnListClickFn, "LISTCLICK_CB");
        Handler.setCallback(self, callback);
    }
    ...
    pub fn setListActionCallback(self: *Self, callback: ?OnListActionFn) void {
        const Handler = CallbackHandler(Self, OnListActionFn, "LISTACTION_CB");
        Handler.setCallback(self, callback);
    }
    ...
    pub fn setImageValueChangedCallback(self: *Self, callback: ?OnImageValueChangedFn) void {
        const Handler = CallbackHandler(Self, OnImageValueChangedFn, "IMAGEVALUECHANGED_CB");
        Handler.setCallback(self, callback);
    }

    pub fn setListRemoveCallback(self: *Self, callback: ?OnListRemoveFn) void {
        const Handler = CallbackHandler(Self, OnListRemoveFn, "LISTREMOVE_CB");
        Handler.setCallback(self, callback);
    }
    ...
    pub fn setListInsertCallback(self: *Self, callback: ?OnListInsertFn) void {
        const Handler = CallbackHandler(Self, OnListInsertFn, "LISTINSERT_CB");
        Handler.setCallback(self, callback);
    }
    ...
    pub fn setListDrawCallback(self: *Self, callback: ?OnListDrawFn) void {
        const Handler = CallbackHandler(Self, OnListDrawFn, "LISTDRAW_CB");
        Handler.setCallback(self, callback);
    }
