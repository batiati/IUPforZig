...
pub const FlatScrollBox = opaque {
    ...
    pub const Initializer = struct {
        ...
        /// the child handle.
        pub fn scrollToChildHandle(self: *Initializer, arg: anytype) !Initializer {
            if (self.last_error) |_| return self.*;
            interop.setHandleAttribute(self.ref, "SCROLLTOCHILD_HANDLE", .{}, arg);
            return self.*;
        }

        pub fn scrollToChildHandleHandleName(self: *Initializer, arg: [:0]const u8) Initializer {
            if (self.last_error) |_| return self.*;
    ...
    /// SCROLLTOCHILD_HANDLE (write-only): same as SCROLLTOCHILD but directly using
    /// the child handle.
    pub fn scrollToChildHandle(self: *Self, arg: anytype) !void {
        interop.setHandleAttribute(self, "SCROLLTOCHILD_HANDLE", .{}, arg);
    }
