...
pub const FlatScrollBox = opaque {
    pub const CLASS_NAME = "flatscrollbox";
    const Self = @This();
    ...
    pub const Initializer = struct {
        ...
        pub fn scrollToChild(self: *Initializer, arg: [:0]const u8) Initializer {
            c.setStrAttribute(self.ref, "SCROLLTOCHILD", void, void, arg);
            return self.*;
        }
        ...
        /// 
        /// LAYOUTDRAG (non inheritable): When the scrollbar is moved automatically
        /// update the children layout.
        /// Default: YES.
    ...
    pub fn scrollToChild(self: *Self, arg: [:0]const u8) void {
        c.setStrAttribute(self, "SCROLLTOCHILD", void, void, arg);
    }
...
test "FlatScrollBox TipBalloon" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setTipBalloon(true).unwrap());
    defer item.deinit();
...
test "FlatScrollBox HandleName" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setHandleName("Hello").unwrap());
    defer item.deinit();
...
test "FlatScrollBox CanvasBox" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setCanvasBox(true).unwrap());
    defer item.deinit();
...
test "FlatScrollBox TipBgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setTipBgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatScrollBox XMin" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setXMin(42).unwrap());
    defer item.deinit();
...
test "FlatScrollBox MaxSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setMaxSize(9, 10).unwrap());
    defer item.deinit();
...
test "FlatScrollBox DrawTextWrap" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setDrawTextWrap(true).unwrap());
    defer item.deinit();
...
test "FlatScrollBox DrawUsedIRect2d" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setDrawUsedIRect2d(true).unwrap());
    defer item.deinit();
...
test "FlatScrollBox Position" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setPosition(9, 10).unwrap());
    defer item.deinit();
...
test "FlatScrollBox DropFilesTarget" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setDropFilesTarget(true).unwrap());
    defer item.deinit();
...
test "FlatScrollBox DrawTextAlignment" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setDrawTextAlignment(.ACenter).unwrap());
    defer item.deinit();
...
test "FlatScrollBox Tip" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setTip("Hello").unwrap());
    defer item.deinit();
...
test "FlatScrollBox DrawTextLayoutCenter" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setDrawTextLayoutCenter(true).unwrap());
    defer item.deinit();
...
test "FlatScrollBox CanFocus" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setCanFocus(true).unwrap());
    defer item.deinit();
...
test "FlatScrollBox DragSourceMove" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setDragSourceMove(true).unwrap());
    defer item.deinit();
...
test "FlatScrollBox Visible" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setVisible(true).unwrap());
    defer item.deinit();
...
test "FlatScrollBox LineX" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setLineX(3.14).unwrap());
    defer item.deinit();
...
test "FlatScrollBox Cursor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setCursor("Hello").unwrap());
    defer item.deinit();
...
test "FlatScrollBox LineY" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setLineY(3.14).unwrap());
    defer item.deinit();
...
test "FlatScrollBox DrawLineWidth" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setDrawLineWidth(42).unwrap());
    defer item.deinit();
...
test "FlatScrollBox DragDrop" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setDragDrop(true).unwrap());
    defer item.deinit();
...
test "FlatScrollBox DrawAntialias" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setDrawAntialias(42).unwrap());
    defer item.deinit();
...
test "FlatScrollBox Theme" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setTheme("Hello").unwrap());
    defer item.deinit();
...
test "FlatScrollBox DragCursorCopy" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setDragCursorCopy("Hello").unwrap());
    defer item.deinit();
...
test "FlatScrollBox HtTransparent" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setHtTransparent(true).unwrap());
    defer item.deinit();
...
test "FlatScrollBox ChildOffset" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setChildOffset(9, 10).unwrap());
    defer item.deinit();
...
test "FlatScrollBox Expand" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setExpand(.Yes).unwrap());
    defer item.deinit();
...
test "FlatScrollBox DrawFont" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setDrawFont("Hello").unwrap());
    defer item.deinit();
...
test "FlatScrollBox Size" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setSize(9, 10).unwrap());
    defer item.deinit();
...
test "FlatScrollBox PosX" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setPosX(3.14).unwrap());
    defer item.deinit();
...
test "FlatScrollBox PosY" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setPosY(3.14).unwrap());
    defer item.deinit();
...
test "FlatScrollBox YMin" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setYMin(42).unwrap());
    defer item.deinit();
...
test "FlatScrollBox DrawMakeInactive" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setDrawMakeInactive(true).unwrap());
    defer item.deinit();
...
test "FlatScrollBox FontSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setFontSize(42).unwrap());
    defer item.deinit();
...
test "FlatScrollBox DropTypes" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setDropTypes("Hello").unwrap());
    defer item.deinit();
...
test "FlatScrollBox UserSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setUserSize(9, 10).unwrap());
    defer item.deinit();
...
test "FlatScrollBox TipDelay" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setTipDelay(42).unwrap());
    defer item.deinit();
...
test "FlatScrollBox DragStart" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setDragStart(9, 10).unwrap());
    defer item.deinit();
...
test "FlatScrollBox PropagateFocus" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setPropagateFocus(true).unwrap());
    defer item.deinit();
...
test "FlatScrollBox XMax" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setXMax(42).unwrap());
    defer item.deinit();
...
test "FlatScrollBox BgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setBgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatScrollBox TipBalloonTitle" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setTipBalloonTitle("Hello").unwrap());
    defer item.deinit();
...
test "FlatScrollBox DropTarget" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setDropTarget(true).unwrap());
    defer item.deinit();
...
test "FlatScrollBox DX" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setDX(3.14).unwrap());
    defer item.deinit();
...
test "FlatScrollBox DY" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setDY(3.14).unwrap());
    defer item.deinit();
...
test "FlatScrollBox DrawTextEllipsis" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setDrawTextEllipsis(true).unwrap());
    defer item.deinit();
...
test "FlatScrollBox DragSource" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setDragSource(true).unwrap());
    defer item.deinit();
...
test "FlatScrollBox DrawTextClip" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setDrawTextClip(true).unwrap());
    defer item.deinit();
...
test "FlatScrollBox LayoutDrag" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setLayoutDrag(true).unwrap());
    defer item.deinit();
...
test "FlatScrollBox Floating" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setFloating(.Yes).unwrap());
    defer item.deinit();
...
test "FlatScrollBox NormalizerGroup" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setNormalizerGroup("Hello").unwrap());
    defer item.deinit();
...
test "FlatScrollBox RasterSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setRasterSize(9, 10).unwrap());
    defer item.deinit();
...
test "FlatScrollBox TipFgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setTipFgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatScrollBox ControlId" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setControlId(42).unwrap());
    defer item.deinit();
...
test "FlatScrollBox FontFace" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setFontFace("Hello").unwrap());
    defer item.deinit();
...
test "FlatScrollBox DrawColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setDrawColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatScrollBox DrawTextOrientation" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setDrawTextOrientation(3.14).unwrap());
    defer item.deinit();
...
test "FlatScrollBox DrawBgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setDrawBgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatScrollBox Name" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setName("Hello").unwrap());
    defer item.deinit();
...
test "FlatScrollBox BackingStore" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setBackingStore(true).unwrap());
    defer item.deinit();
...
test "FlatScrollBox TipBalloonTitleIcon" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setTipBalloonTitleIcon(true).unwrap());
    defer item.deinit();
...
test "FlatScrollBox DrawStyle" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setDrawStyle(.Fill).unwrap());
    defer item.deinit();
...
test "FlatScrollBox Active" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setActive(true).unwrap());
    defer item.deinit();
...
test "FlatScrollBox TipVisible" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setTipVisible(true).unwrap());
    defer item.deinit();
...
test "FlatScrollBox YMax" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setYMax(42).unwrap());
    defer item.deinit();
...
test "FlatScrollBox ExpandWeight" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setExpandWeight(3.14).unwrap());
    defer item.deinit();
...
test "FlatScrollBox MinSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setMinSize(9, 10).unwrap());
    defer item.deinit();
...
test "FlatScrollBox ArrowImages" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setArrowImages(42).unwrap());
    defer item.deinit();
...
test "FlatScrollBox NTheme" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setNTheme("Hello").unwrap());
    defer item.deinit();
...
test "FlatScrollBox DragTypes" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setDragTypes("Hello").unwrap());
    defer item.deinit();
...
test "FlatScrollBox WheelDropFocus" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setWheelDropFocus(true).unwrap());
    defer item.deinit();
...
test "FlatScrollBox FontStyle" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setFontStyle("Hello").unwrap());
    defer item.deinit();
...
test "FlatScrollBox Touch" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setTouch(true).unwrap());
    defer item.deinit();
...
test "FlatScrollBox DragCursor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setDragCursor("Hello").unwrap());
    defer item.deinit();
...
test "FlatScrollBox Font" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatScrollBox.init().setFont("Hello").unwrap());
    defer item.deinit();
