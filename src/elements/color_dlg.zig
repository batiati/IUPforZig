...
test "ColorDlg Cursor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorDlg.init().setCursor("Hello").unwrap());
    defer item.deinit();
...
test "ColorDlg DragCursorCopy" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorDlg.init().setDragCursorCopy("Hello").unwrap());
    defer item.deinit();
...
test "ColorDlg TrayImage" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorDlg.init().setTrayImage("Hello").unwrap());
    defer item.deinit();
...
test "ColorDlg DragCursor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorDlg.init().setDragCursor("Hello").unwrap());
    defer item.deinit();
