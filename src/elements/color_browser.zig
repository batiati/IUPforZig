...
pub const ColorBrowser = opaque {
    ...
    pub const Initializer = struct {
        ...
        /// [in C] ih:drag_cb(r: number, g: number, b: number) -> (ret: number) [in
        /// Lua]
        pub fn setDragCallback(self: Initializer, callback: ?*const OnDragFn) Initializer {
        ...
        /// [in C] ih:change_cb(r: number, g: number, b: number) -> (ret: number) [in
        /// Lua]
        pub fn setChangeCallback(self: Initializer, callback: ?*const OnChangeFn) Initializer {
    ...
    /// [in C] ih:drag_cb(r: number, g: number, b: number) -> (ret: number) [in
    /// Lua]
    pub fn setDragCallback(self: *Self, callback: ?*const OnDragFn) void {
        const Handler = CallbackHandler(Self, OnDragFn, "DRAG_CB");
        Handler.setCallback(self, callback);
    }
    ...
    /// [in C] ih:change_cb(r: number, g: number, b: number) -> (ret: number) [in
    /// Lua]
    pub fn setChangeCallback(self: *Self, callback: ?*const OnChangeFn) void {
        const Handler = CallbackHandler(Self, OnChangeFn, "CHANGE_CB");
        Handler.setCallback(self, callback);
    }
...
test "ColorBrowser TipIcon" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setTipIcon("Hello").unwrap());
    defer item.deinit();
...
test "ColorBrowser TipMarkup" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setTipMarkup("Hello").unwrap());
    defer item.deinit();
