...
/// The transformation defines a coordinate color system called HSI, that is
/// still the RGB color space but using cylindrical coordinates.
...
/// on the CD library anymore.) For a dialog that simply returns the selected
/// color, you can use function IupGetColor or IupColorDlg.
pub const ColorBrowser = opaque {
    pub const CLASS_NAME = "colorbrowser";
    const Self = @This();
...
test "ColorBrowser TipBalloon" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setTipBalloon(true).unwrap());
    defer item.deinit();
...
test "ColorBrowser HandleName" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setHandleName("Hello").unwrap());
    defer item.deinit();
...
test "ColorBrowser TipBgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setTipBgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "ColorBrowser XMin" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setXMin(42).unwrap());
    defer item.deinit();
...
test "ColorBrowser MaxSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setMaxSize(9, 10).unwrap());
    defer item.deinit();
...
test "ColorBrowser DrawTextWrap" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setDrawTextWrap(true).unwrap());
    defer item.deinit();
...
test "ColorBrowser DrawUsedIRect2d" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setDrawUsedIRect2d(true).unwrap());
    defer item.deinit();
...
test "ColorBrowser Position" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setPosition(9, 10).unwrap());
    defer item.deinit();
...
test "ColorBrowser DropFilesTarget" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setDropFilesTarget(true).unwrap());
    defer item.deinit();
...
test "ColorBrowser DrawTextAlignment" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setDrawTextAlignment(.ACenter).unwrap());
    defer item.deinit();
...
test "ColorBrowser Tip" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setTip("Hello").unwrap());
    defer item.deinit();
...
test "ColorBrowser DrawTextLayoutCenter" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setDrawTextLayoutCenter(true).unwrap());
    defer item.deinit();
...
test "ColorBrowser CanFocus" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setCanFocus(true).unwrap());
    defer item.deinit();
...
test "ColorBrowser DragSourceMove" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setDragSourceMove(true).unwrap());
    defer item.deinit();
...
test "ColorBrowser Visible" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setVisible(true).unwrap());
    defer item.deinit();
...
test "ColorBrowser LineX" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setLineX(3.14).unwrap());
    defer item.deinit();
...
test "ColorBrowser Cursor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setCursor("Hello").unwrap());
    defer item.deinit();
...
test "ColorBrowser LineY" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setLineY(3.14).unwrap());
    defer item.deinit();
...
test "ColorBrowser DrawLineWidth" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setDrawLineWidth(42).unwrap());
    defer item.deinit();
...
test "ColorBrowser DragDrop" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setDragDrop(true).unwrap());
    defer item.deinit();
...
test "ColorBrowser DrawAntialias" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setDrawAntialias(42).unwrap());
    defer item.deinit();
...
test "ColorBrowser Theme" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setTheme("Hello").unwrap());
    defer item.deinit();
...
test "ColorBrowser DragCursorCopy" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setDragCursorCopy("Hello").unwrap());
    defer item.deinit();
...
test "ColorBrowser HtTransparent" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setHtTransparent(true).unwrap());
    defer item.deinit();
...
test "ColorBrowser Expand" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setExpand(.Yes).unwrap());
    defer item.deinit();
...
test "ColorBrowser DrawFont" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setDrawFont("Hello").unwrap());
    defer item.deinit();
...
test "ColorBrowser Size" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setSize(9, 10).unwrap());
    defer item.deinit();
...
test "ColorBrowser PosX" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setPosX(3.14).unwrap());
    defer item.deinit();
...
test "ColorBrowser PosY" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setPosY(3.14).unwrap());
    defer item.deinit();
...
test "ColorBrowser YMin" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setYMin(42).unwrap());
    defer item.deinit();
...
test "ColorBrowser DrawMakeInactive" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setDrawMakeInactive(true).unwrap());
    defer item.deinit();
...
test "ColorBrowser FontSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setFontSize(42).unwrap());
    defer item.deinit();
...
test "ColorBrowser DropTypes" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setDropTypes("Hello").unwrap());
    defer item.deinit();
...
test "ColorBrowser UserSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setUserSize(9, 10).unwrap());
    defer item.deinit();
...
test "ColorBrowser TipDelay" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setTipDelay(42).unwrap());
    defer item.deinit();
...
test "ColorBrowser ScrollBar" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setScrollBar(true).unwrap());
    defer item.deinit();
...
test "ColorBrowser DragStart" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setDragStart(9, 10).unwrap());
    defer item.deinit();
...
test "ColorBrowser XAutoHide" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setXAutoHide(true).unwrap());
    defer item.deinit();
...
test "ColorBrowser PropagateFocus" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setPropagateFocus(true).unwrap());
    defer item.deinit();
...
test "ColorBrowser XMax" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setXMax(42).unwrap());
    defer item.deinit();
...
test "ColorBrowser BgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setBgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "ColorBrowser TipBalloonTitle" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setTipBalloonTitle("Hello").unwrap());
    defer item.deinit();
...
test "ColorBrowser DropTarget" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setDropTarget(true).unwrap());
    defer item.deinit();
...
test "ColorBrowser DX" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setDX(3.14).unwrap());
    defer item.deinit();
...
test "ColorBrowser DY" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setDY(3.14).unwrap());
    defer item.deinit();
...
test "ColorBrowser DrawTextEllipsis" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setDrawTextEllipsis(true).unwrap());
    defer item.deinit();
...
test "ColorBrowser DragSource" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setDragSource(true).unwrap());
    defer item.deinit();
...
test "ColorBrowser DrawTextClip" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setDrawTextClip(true).unwrap());
    defer item.deinit();
...
test "ColorBrowser Floating" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setFloating(.Yes).unwrap());
    defer item.deinit();
...
test "ColorBrowser NormalizerGroup" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setNormalizerGroup("Hello").unwrap());
    defer item.deinit();
...
test "ColorBrowser RasterSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setRasterSize(9, 10).unwrap());
    defer item.deinit();
...
test "ColorBrowser TipFgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setTipFgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "ColorBrowser ControlId" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setControlId(42).unwrap());
    defer item.deinit();
...
test "ColorBrowser FontFace" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setFontFace("Hello").unwrap());
    defer item.deinit();
...
test "ColorBrowser DrawColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setDrawColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "ColorBrowser DrawTextOrientation" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setDrawTextOrientation(3.14).unwrap());
    defer item.deinit();
...
test "ColorBrowser DrawBgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setDrawBgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "ColorBrowser Name" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setName("Hello").unwrap());
    defer item.deinit();
...
test "ColorBrowser BackingStore" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setBackingStore(true).unwrap());
    defer item.deinit();
...
test "ColorBrowser TipBalloonTitleIcon" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setTipBalloonTitleIcon(true).unwrap());
    defer item.deinit();
...
test "ColorBrowser YAutoHide" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setYAutoHide(true).unwrap());
    defer item.deinit();
...
test "ColorBrowser DrawStyle" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setDrawStyle(.Fill).unwrap());
    defer item.deinit();
...
test "ColorBrowser Active" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setActive(true).unwrap());
    defer item.deinit();
...
test "ColorBrowser TipVisible" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setTipVisible(true).unwrap());
    defer item.deinit();
...
test "ColorBrowser YMax" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setYMax(42).unwrap());
    defer item.deinit();
...
test "ColorBrowser ExpandWeight" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setExpandWeight(3.14).unwrap());
    defer item.deinit();
...
test "ColorBrowser MinSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setMinSize(9, 10).unwrap());
    defer item.deinit();
...
test "ColorBrowser NTheme" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setNTheme("Hello").unwrap());
    defer item.deinit();
...
test "ColorBrowser DragTypes" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setDragTypes("Hello").unwrap());
    defer item.deinit();
...
test "ColorBrowser WheelDropFocus" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setWheelDropFocus(true).unwrap());
    defer item.deinit();
...
test "ColorBrowser FontStyle" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setFontStyle("Hello").unwrap());
    defer item.deinit();
...
test "ColorBrowser Touch" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setTouch(true).unwrap());
    defer item.deinit();
...
test "ColorBrowser DragCursor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setDragCursor("Hello").unwrap());
    defer item.deinit();
...
test "ColorBrowser Font" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ColorBrowser.init().setFont("Hello").unwrap());
    defer item.deinit();
