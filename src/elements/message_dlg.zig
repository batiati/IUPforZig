...
pub const MessageDlg = opaque {
    ...
    pub const Initializer = struct {
        ...
        pub fn setDialogType(self: Initializer, arg: ?DialogType) Initializer {
            ...
            if (arg) |value| switch (value) {
                .Error => interop.setStrAttribute(self.ref, "DIALOGTYPE", .{}, "ERROR"),
                .Warning => interop.setStrAttribute(self.ref, "DIALOGTYPE", .{}, "WARNING"),
                .Information => interop.setStrAttribute(self.ref, "DIALOGTYPE", .{}, "INFORMATION"),
                .Question => interop.setStrAttribute(self.ref, "DIALOGTYPE", .{}, "QUESTION"),
            } else {
        ...
        pub fn setButtons(self: Initializer, arg: ?Buttons) Initializer {
            if (self.last_error) |_| return self;
            if (arg) |value| switch (value) {
                .OkCanCel => interop.setStrAttribute(self.ref, "BUTTONS", .{}, "OKCANCEL"),
                .RetrYCanCel => interop.setStrAttribute(self.ref, "BUTTONS", .{}, "RETRYCANCEL"),
                .YesNo => interop.setStrAttribute(self.ref, "BUTTONS", .{}, "YESNO"),
                .YesNoCanCel => interop.setStrAttribute(self.ref, "BUTTONS", .{}, "YESNOCANCEL"),
                .Ok => interop.setStrAttribute(self.ref, "BUTTONS", .{}, "OK"),
            } else {
                interop.clearAttribute(self.ref, "BUTTONS", .{});
            }
            return self;
        }
    ...
    pub fn setDialogType(self: *Self, arg: ?DialogType) void {
        if (arg) |value| switch (value) {
            .Error => interop.setStrAttribute(self, "DIALOGTYPE", .{}, "ERROR"),
            .Warning => interop.setStrAttribute(self, "DIALOGTYPE", .{}, "WARNING"),
            .Information => interop.setStrAttribute(self, "DIALOGTYPE", .{}, "INFORMATION"),
            .Question => interop.setStrAttribute(self, "DIALOGTYPE", .{}, "QUESTION"),
        } else {
    ...
    pub fn getButtons(self: *Self) ?Buttons {
        var ret = interop.getStrAttribute(self, "BUTTONS", .{});
    ...
    pub fn setButtons(self: *Self, arg: ?Buttons) void {
        if (arg) |value| switch (value) {
            .OkCanCel => interop.setStrAttribute(self, "BUTTONS", .{}, "OKCANCEL"),
            .RetrYCanCel => interop.setStrAttribute(self, "BUTTONS", .{}, "RETRYCANCEL"),
            .YesNo => interop.setStrAttribute(self, "BUTTONS", .{}, "YESNO"),
            .YesNoCanCel => interop.setStrAttribute(self, "BUTTONS", .{}, "YESNOCANCEL"),
            .Ok => interop.setStrAttribute(self, "BUTTONS", .{}, "OK"),
        } else {
            interop.clearAttribute(self, "BUTTONS", .{});
        }
    }
...
test "MessageDlg TipIcon" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.MessageDlg.init().setTipIcon("Hello").unwrap());
    defer item.deinit();
...
test "MessageDlg HideTitleBar" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.MessageDlg.init().setHideTitleBar("Hello").unwrap());
    defer item.deinit();
...
test "MessageDlg TipMarkup" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.MessageDlg.init().setTipMarkup("Hello").unwrap());
    defer item.deinit();
...
test "MessageDlg TrayTipMarkup" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.MessageDlg.init().setTrayTipMarkup("Hello").unwrap());
    defer item.deinit();
