...
pub const ScrollBox = opaque {
    pub const CLASS_NAME = "scrollbox";
    const Self = @This();
...
test "ScrollBox TipBalloon" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setTipBalloon(true).unwrap());
    defer item.deinit();
...
test "ScrollBox HandleName" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setHandleName("Hello").unwrap());
    defer item.deinit();
...
test "ScrollBox CanvasBox" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setCanvasBox(true).unwrap());
    defer item.deinit();
...
test "ScrollBox TipBgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setTipBgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "ScrollBox XMin" {
    ...
    var item = try (iup.ScrollBox.init().setXMin(42).unwrap());
    defer item.deinit();
...
test "ScrollBox MaxSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setMaxSize(9, 10).unwrap());
    defer item.deinit();
...
test "ScrollBox DrawTextWrap" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setDrawTextWrap(true).unwrap());
    defer item.deinit();
...
test "ScrollBox DrawUsedIRect2d" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setDrawUsedIRect2d(true).unwrap());
    defer item.deinit();
...
test "ScrollBox Position" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setPosition(9, 10).unwrap());
    defer item.deinit();
...
test "ScrollBox DropFilesTarget" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setDropFilesTarget(true).unwrap());
    defer item.deinit();
...
test "ScrollBox DrawTextAlignment" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setDrawTextAlignment(.ACenter).unwrap());
    defer item.deinit();
...
test "ScrollBox Tip" {
    ...
    var item = try (iup.ScrollBox.init().setTip("Hello").unwrap());
    defer item.deinit();
...
test "ScrollBox DrawTextLayoutCenter" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setDrawTextLayoutCenter(true).unwrap());
    defer item.deinit();
...
test "ScrollBox CanFocus" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setCanFocus(true).unwrap());
    defer item.deinit();
...
test "ScrollBox DragSourceMove" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setDragSourceMove(true).unwrap());
    defer item.deinit();
...
test "ScrollBox Visible" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setVisible(true).unwrap());
    defer item.deinit();
...
test "ScrollBox LineX" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setLineX(3.14).unwrap());
    defer item.deinit();
...
test "ScrollBox Cursor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setCursor("Hello").unwrap());
    defer item.deinit();
...
test "ScrollBox LineY" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setLineY(3.14).unwrap());
    defer item.deinit();
...
test "ScrollBox DrawLineWidth" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setDrawLineWidth(42).unwrap());
    defer item.deinit();
...
test "ScrollBox DragDrop" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setDragDrop(true).unwrap());
    defer item.deinit();
...
test "ScrollBox DrawAntialias" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setDrawAntialias(42).unwrap());
    defer item.deinit();
...
test "ScrollBox Theme" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setTheme("Hello").unwrap());
    defer item.deinit();
...
test "ScrollBox DragCursorCopy" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setDragCursorCopy("Hello").unwrap());
    defer item.deinit();
...
test "ScrollBox HtTransparent" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setHtTransparent(true).unwrap());
    defer item.deinit();
...
test "ScrollBox ChildOffset" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setChildOffset(9, 10).unwrap());
    defer item.deinit();
...
test "ScrollBox Expand" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setExpand(.Yes).unwrap());
    defer item.deinit();
...
test "ScrollBox DrawFont" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setDrawFont("Hello").unwrap());
    defer item.deinit();
...
test "ScrollBox Size" {
    ...
    var item = try (iup.ScrollBox.init().setSize(9, 10).unwrap());
    defer item.deinit();
...
test "ScrollBox PosX" {
    ...
    var item = try (iup.ScrollBox.init().setPosX(3.14).unwrap());
    defer item.deinit();
...
test "ScrollBox PosY" {
    ...
    var item = try (iup.ScrollBox.init().setPosY(3.14).unwrap());
    defer item.deinit();
...
test "ScrollBox YMin" {
    ...
    var item = try (iup.ScrollBox.init().setYMin(42).unwrap());
    defer item.deinit();
...
test "ScrollBox DrawMakeInactive" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setDrawMakeInactive(true).unwrap());
    defer item.deinit();
...
test "ScrollBox FontSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setFontSize(42).unwrap());
    defer item.deinit();
...
test "ScrollBox DropTypes" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setDropTypes("Hello").unwrap());
    defer item.deinit();
...
test "ScrollBox UserSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setUserSize(9, 10).unwrap());
    defer item.deinit();
...
test "ScrollBox TipDelay" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setTipDelay(42).unwrap());
    defer item.deinit();
...
test "ScrollBox DragStart" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setDragStart(9, 10).unwrap());
    defer item.deinit();
...
test "ScrollBox PropagateFocus" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setPropagateFocus(true).unwrap());
    defer item.deinit();
...
test "ScrollBox XMax" {
    ...
    var item = try (iup.ScrollBox.init().setXMax(42).unwrap());
    defer item.deinit();
...
test "ScrollBox BgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setBgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "ScrollBox TipBalloonTitle" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setTipBalloonTitle("Hello").unwrap());
    defer item.deinit();
...
test "ScrollBox DropTarget" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setDropTarget(true).unwrap());
    defer item.deinit();
...
test "ScrollBox DX" {
    ...
    var item = try (iup.ScrollBox.init().setDX(3.14).unwrap());
    defer item.deinit();
...
test "ScrollBox DY" {
    ...
    var item = try (iup.ScrollBox.init().setDY(3.14).unwrap());
    defer item.deinit();
...
test "ScrollBox DrawTextEllipsis" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setDrawTextEllipsis(true).unwrap());
    defer item.deinit();
...
test "ScrollBox DragSource" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setDragSource(true).unwrap());
    defer item.deinit();
...
test "ScrollBox DrawTextClip" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setDrawTextClip(true).unwrap());
    defer item.deinit();
...
test "ScrollBox LayoutDrag" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setLayoutDrag(true).unwrap());
    defer item.deinit();
...
test "ScrollBox Floating" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setFloating(.Yes).unwrap());
    defer item.deinit();
...
test "ScrollBox NormalizerGroup" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setNormalizerGroup("Hello").unwrap());
    defer item.deinit();
...
test "ScrollBox RasterSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setRasterSize(9, 10).unwrap());
    defer item.deinit();
...
test "ScrollBox TipFgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setTipFgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "ScrollBox ControlId" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setControlId(42).unwrap());
    defer item.deinit();
...
test "ScrollBox FontFace" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setFontFace("Hello").unwrap());
    defer item.deinit();
...
test "ScrollBox DrawColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setDrawColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "ScrollBox DrawTextOrientation" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setDrawTextOrientation(3.14).unwrap());
    defer item.deinit();
...
test "ScrollBox DrawBgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setDrawBgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "ScrollBox Name" {
    ...
    var item = try (iup.ScrollBox.init().setName("Hello").unwrap());
    defer item.deinit();
...
test "ScrollBox BackingStore" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setBackingStore(true).unwrap());
    defer item.deinit();
...
test "ScrollBox TipBalloonTitleIcon" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setTipBalloonTitleIcon(true).unwrap());
    defer item.deinit();
...
test "ScrollBox DrawStyle" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setDrawStyle(.Fill).unwrap());
    defer item.deinit();
...
test "ScrollBox Active" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setActive(true).unwrap());
    defer item.deinit();
...
test "ScrollBox TipVisible" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setTipVisible(true).unwrap());
    defer item.deinit();
...
test "ScrollBox YMax" {
    ...
    var item = try (iup.ScrollBox.init().setYMax(42).unwrap());
    defer item.deinit();
...
test "ScrollBox ExpandWeight" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setExpandWeight(3.14).unwrap());
    defer item.deinit();
...
test "ScrollBox MinSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setMinSize(9, 10).unwrap());
    defer item.deinit();
...
test "ScrollBox NTheme" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setNTheme("Hello").unwrap());
    defer item.deinit();
...
test "ScrollBox DragTypes" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setDragTypes("Hello").unwrap());
    defer item.deinit();
...
test "ScrollBox WheelDropFocus" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setWheelDropFocus(true).unwrap());
    defer item.deinit();
...
test "ScrollBox FontStyle" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setFontStyle("Hello").unwrap());
    defer item.deinit();
...
test "ScrollBox Touch" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setTouch(true).unwrap());
    defer item.deinit();
...
test "ScrollBox DragCursor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.ScrollBox.init().setDragCursor("Hello").unwrap());
    defer item.deinit();
...
test "ScrollBox Font" {
    ...
    var item = try (iup.ScrollBox.init().setFont("Hello").unwrap());
    defer item.deinit();
