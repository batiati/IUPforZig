...
/// 
/// Creates a Valuator control, but it does not have native decorations.
...
/// more flexibility for additional options.
/// But ticks are NOT supported.
/// It inherits from IupCanvas.
pub const FlatVal = opaque {
    pub const CLASS_NAME = "flatval";
    const Self = @This();
    ...
    pub const OnFlatWheelFn = fn (self: *Self, arg0: f32, arg1: i32, arg2: i32, arg3: [:0]const u8) anyerror!void;
    ...
    /// right variations of min to max.
    /// Default: "HORIZONTAL".
    ...
    pub const Initializer = struct {
        ...
        /// Can be set to NULL.
        /// If NULL BORDERCOLOR will be used instead.
        ...
        pub fn setFlatWheelCallback(self: *Initializer, callback: ?OnFlatWheelFn) Initializer {
            const Handler = CallbackHandler(Self, OnFlatWheelFn, "FLAT_WHEEL_CB");
            Handler.setCallback(self.ref, callback);
            return self.*;
        }
    ...
    pub fn setFlatWheelCallback(self: *Self, callback: ?OnFlatWheelFn) void {
        const Handler = CallbackHandler(Self, OnFlatWheelFn, "FLAT_WHEEL_CB");
        Handler.setCallback(self, callback);
    }
...
test "FlatVal FgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setFgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatVal TipBalloon" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setTipBalloon(true).unwrap());
    defer item.deinit();
...
test "FlatVal HandleName" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setHandleName("Hello").unwrap());
    defer item.deinit();
...
test "FlatVal TipBgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setTipBgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatVal XMin" {
    ...
    var item = try (iup.FlatVal.init().setXMin(42).unwrap());
    defer item.deinit();
...
test "FlatVal Step" {
    ...
    var item = try (iup.FlatVal.init().setStep(3.14).unwrap());
    defer item.deinit();
...
test "FlatVal MaxSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setMaxSize(9, 10).unwrap());
    defer item.deinit();
...
test "FlatVal DrawTextWrap" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setDrawTextWrap(true).unwrap());
    defer item.deinit();
...
test "FlatVal DrawUsedIRect2d" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setDrawUsedIRect2d(true).unwrap());
    defer item.deinit();
...
test "FlatVal FocusFeedback" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setFocusFeedback(true).unwrap());
    defer item.deinit();
...
test "FlatVal Position" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setPosition(9, 10).unwrap());
    defer item.deinit();
...
test "FlatVal DropFilesTarget" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setDropFilesTarget(true).unwrap());
    defer item.deinit();
...
test "FlatVal DrawTextAlignment" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setDrawTextAlignment(.ACenter).unwrap());
    defer item.deinit();
...
test "FlatVal Tip" {
    ...
    var item = try (iup.FlatVal.init().setTip("Hello").unwrap());
    defer item.deinit();
...
test "FlatVal DrawTextLayoutCenter" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setDrawTextLayoutCenter(true).unwrap());
    defer item.deinit();
...
test "FlatVal DragSourceMove" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setDragSourceMove(true).unwrap());
    defer item.deinit();
...
test "FlatVal PsColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setPsColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatVal Visible" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setVisible(true).unwrap());
    defer item.deinit();
...
test "FlatVal Image" {
    ...
    var item = try (iup.FlatVal.init().setImage("Hello").unwrap());
    defer item.deinit();
...
test "FlatVal LineX" {
    ...
    var item = try (iup.FlatVal.init().setLineX(3.14).unwrap());
    defer item.deinit();
...
test "FlatVal Cursor" {
    ...
    var item = try (iup.FlatVal.init().setCursor("Hello").unwrap());
    defer item.deinit();
...
test "FlatVal LineY" {
    ...
    var item = try (iup.FlatVal.init().setLineY(3.14).unwrap());
    defer item.deinit();
...
test "FlatVal DrawLineWidth" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setDrawLineWidth(42).unwrap());
    defer item.deinit();
...
test "FlatVal DragDrop" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setDragDrop(true).unwrap());
    defer item.deinit();
...
test "FlatVal DrawAntialias" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setDrawAntialias(42).unwrap());
    defer item.deinit();
...
test "FlatVal Theme" {
    ...
    var item = try (iup.FlatVal.init().setTheme("Hello").unwrap());
    defer item.deinit();
...
test "FlatVal DragCursorCopy" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setDragCursorCopy("Hello").unwrap());
    defer item.deinit();
...
test "FlatVal HtTransparent" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setHtTransparent(true).unwrap());
    defer item.deinit();
...
test "FlatVal Expand" {
    ...
    var item = try (iup.FlatVal.init().setExpand(.Yes).unwrap());
    defer item.deinit();
...
test "FlatVal DrawFont" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setDrawFont("Hello").unwrap());
    defer item.deinit();
...
test "FlatVal Size" {
    ...
    var item = try (iup.FlatVal.init().setSize(9, 10).unwrap());
    defer item.deinit();
...
test "FlatVal PosX" {
    ...
    var item = try (iup.FlatVal.init().setPosX(3.14).unwrap());
    defer item.deinit();
...
test "FlatVal PosY" {
    ...
    var item = try (iup.FlatVal.init().setPosY(3.14).unwrap());
    defer item.deinit();
...
test "FlatVal BorderHlColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setBorderHlColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatVal YMin" {
    ...
    var item = try (iup.FlatVal.init().setYMin(42).unwrap());
    defer item.deinit();
...
test "FlatVal DrawMakeInactive" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setDrawMakeInactive(true).unwrap());
    defer item.deinit();
...
test "FlatVal FontSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setFontSize(42).unwrap());
    defer item.deinit();
...
test "FlatVal Min" {
    ...
    var item = try (iup.FlatVal.init().setMin(3.14).unwrap());
    defer item.deinit();
...
test "FlatVal DropTypes" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setDropTypes("Hello").unwrap());
    defer item.deinit();
...
test "FlatVal UserSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setUserSize(9, 10).unwrap());
    defer item.deinit();
...
test "FlatVal TipDelay" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setTipDelay(42).unwrap());
    defer item.deinit();
...
test "FlatVal ScrollBar" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setScrollBar(true).unwrap());
    defer item.deinit();
...
test "FlatVal DragStart" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setDragStart(9, 10).unwrap());
    defer item.deinit();
...
test "FlatVal XAutoHide" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setXAutoHide(true).unwrap());
    defer item.deinit();
...
test "FlatVal PropagateFocus" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setPropagateFocus(true).unwrap());
    defer item.deinit();
...
test "FlatVal XMax" {
    ...
    var item = try (iup.FlatVal.init().setXMax(42).unwrap());
    defer item.deinit();
...
test "FlatVal BgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setBgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatVal TipBalloonTitle" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setTipBalloonTitle("Hello").unwrap());
    defer item.deinit();
...
test "FlatVal DropTarget" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setDropTarget(true).unwrap());
    defer item.deinit();
...
test "FlatVal DX" {
    ...
    var item = try (iup.FlatVal.init().setDX(3.14).unwrap());
    defer item.deinit();
...
test "FlatVal DY" {
    ...
    var item = try (iup.FlatVal.init().setDY(3.14).unwrap());
    defer item.deinit();
...
test "FlatVal DrawTextEllipsis" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setDrawTextEllipsis(true).unwrap());
    defer item.deinit();
...
test "FlatVal DragSource" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setDragSource(true).unwrap());
    defer item.deinit();
...
test "FlatVal DrawTextClip" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setDrawTextClip(true).unwrap());
    defer item.deinit();
...
test "FlatVal Floating" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setFloating(.Yes).unwrap());
    defer item.deinit();
...
test "FlatVal NormalizerGroup" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setNormalizerGroup("Hello").unwrap());
    defer item.deinit();
...
test "FlatVal BorderPsColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setBorderPsColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatVal RasterSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setRasterSize(9, 10).unwrap());
    defer item.deinit();
...
test "FlatVal BorderColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setBorderColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatVal TipFgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setTipFgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatVal ControlId" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setControlId(42).unwrap());
    defer item.deinit();
...
test "FlatVal HlColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setHlColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatVal FontFace" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setFontFace("Hello").unwrap());
    defer item.deinit();
...
test "FlatVal DrawColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setDrawColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatVal DrawTextOrientation" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setDrawTextOrientation(3.14).unwrap());
    defer item.deinit();
...
test "FlatVal DrawBgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setDrawBgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatVal Name" {
    ...
    var item = try (iup.FlatVal.init().setName("Hello").unwrap());
    defer item.deinit();
...
test "FlatVal BackingStore" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setBackingStore(true).unwrap());
    defer item.deinit();
...
test "FlatVal TipBalloonTitleIcon" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setTipBalloonTitleIcon(true).unwrap());
    defer item.deinit();
...
test "FlatVal YAutoHide" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setYAutoHide(true).unwrap());
    defer item.deinit();
...
test "FlatVal DrawStyle" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setDrawStyle(.Fill).unwrap());
    defer item.deinit();
...
test "FlatVal Value" {
    ...
    var item = try (iup.FlatVal.init().setValue("Hello").unwrap());
    defer item.deinit();
...
test "FlatVal BackImageZoom" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setBackImageZoom(true).unwrap());
    defer item.deinit();
...
test "FlatVal FitToBackImage" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setFitToBackImage(true).unwrap());
    defer item.deinit();
...
test "FlatVal Active" {
    ...
    var item = try (iup.FlatVal.init().setActive(true).unwrap());
    defer item.deinit();
...
test "FlatVal TipVisible" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setTipVisible(true).unwrap());
    defer item.deinit();
...
test "FlatVal ImageHighlight" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setImageHighlight("Hello").unwrap());
    defer item.deinit();
...
test "FlatVal YMax" {
    ...
    var item = try (iup.FlatVal.init().setYMax(42).unwrap());
    defer item.deinit();
...
test "FlatVal BackImage" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setBackImage("Hello").unwrap());
    defer item.deinit();
...
test "FlatVal ExpandWeight" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setExpandWeight(3.14).unwrap());
    defer item.deinit();
...
test "FlatVal MinSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setMinSize(9, 10).unwrap());
    defer item.deinit();
...
test "FlatVal Max" {
    ...
    var item = try (iup.FlatVal.init().setMax(3.14).unwrap());
    defer item.deinit();
...
test "FlatVal NTheme" {
    ...
    var item = try (iup.FlatVal.init().setNTheme("Hello").unwrap());
    defer item.deinit();
...
test "FlatVal DragTypes" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setDragTypes("Hello").unwrap());
    defer item.deinit();
...
test "FlatVal WheelDropFocus" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setWheelDropFocus(true).unwrap());
    defer item.deinit();
...
test "FlatVal BorderWidth" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setBorderWidth(42).unwrap());
    defer item.deinit();
...
test "FlatVal FontStyle" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setFontStyle("Hello").unwrap());
    defer item.deinit();
...
test "FlatVal Touch" {
    ...
    var item = try (iup.FlatVal.init().setTouch(true).unwrap());
    defer item.deinit();
...
test "FlatVal DragCursor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatVal.init().setDragCursor("Hello").unwrap());
    defer item.deinit();
...
test "FlatVal Font" {
    ...
    var item = try (iup.FlatVal.init().setFont("Hello").unwrap());
    defer item.deinit();
