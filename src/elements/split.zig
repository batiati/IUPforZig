...
pub const Split = opaque {
    ...
    pub fn getDirection(self: *Self) ?Direction {
        var ret = c.getStrAttribute(self, "DIRECTION", .{});
    ...
    pub fn setDirection(self: *Self, arg: ?Direction) void {
        if (arg) |value| switch (value) {
            .North => c.setStrAttribute(self, "DIRECTION", .{}, "NORTH"),
            .South => c.setStrAttribute(self, "DIRECTION", .{}, "SOUTH"),
            .West => c.setStrAttribute(self, "DIRECTION", .{}, "WEST"),
            .East => c.setStrAttribute(self, "DIRECTION", .{}, "EAST"),
        } else {
            c.clearAttribute(self, "DIRECTION", .{});
        }
    }
