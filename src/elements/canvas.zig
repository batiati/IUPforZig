...
pub const Canvas = opaque {
    ...
    pub const Initializer = struct {
        ...
        /// Default: "NO".
        /// The secondary attributes are all non inheritable.
        ...
        /// In GTK or Motif if you set the ACTION callback after map then you should
        /// also set BGCOLOR to any value just after setting the callback or the first
        /// redraw will be lost.
        /// Default: "255 255 255".
        ...
        /// Also the horizontal page size.
        /// Default: "0.1".
        /// DY: Size of the thumb in the vertical scrollbar.
        /// Also the vertical page size.
        /// Default: "0.1".
        ...
        /// (since 3.0) LINEY: The amount the thumb moves when a vertical step is performed.
        /// Default: 1/10th of DY.
        /// (since 3.0) XAUTOHIDE: When enabled, if DX >= XMAX-XMIN then the horizontal
        /// scrollbar is hidden.
        /// Default: "YES".
        /// (since 3.0) YAUTOHIDE: When enabled, if DY >= YMAX-YMIN then the vertical
        /// scrollbar is hidden.
        /// Default: "YES".
        /// (since 3.0)
    ...
    /// IupDraw API.
    /// Can be: X11 (Motif), GDK (GTK), Cairo (GTK), D2D (Windows), GDI+ (Windows)
    /// or GDI (Windows).
    /// (since 3.25)
...
test "Canvas TipBalloon" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setTipBalloon(true).unwrap());
    defer item.deinit();
...
test "Canvas HandleName" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setHandleName("Hello").unwrap());
    defer item.deinit();
...
test "Canvas TipBgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setTipBgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "Canvas XMin" {
    ...
    var item = try (iup.Canvas.init().setXMin(42).unwrap());
    defer item.deinit();
...
test "Canvas MaxSize" {
    ...
    var item = try (iup.Canvas.init().setMaxSize(9, 10).unwrap());
    defer item.deinit();
...
test "Canvas DrawTextWrap" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setDrawTextWrap(true).unwrap());
    defer item.deinit();
...
test "Canvas DrawUsedIRect2d" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setDrawUsedIRect2d(true).unwrap());
    defer item.deinit();
...
test "Canvas Position" {
    ...
    var item = try (iup.Canvas.init().setPosition(9, 10).unwrap());
    defer item.deinit();
...
test "Canvas DropFilesTarget" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setDropFilesTarget(true).unwrap());
    defer item.deinit();
...
test "Canvas DrawTextAlignment" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setDrawTextAlignment(.ACenter).unwrap());
    defer item.deinit();
...
test "Canvas Tip" {
    ...
    var item = try (iup.Canvas.init().setTip("Hello").unwrap());
    defer item.deinit();
...
test "Canvas DrawTextLayoutCenter" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setDrawTextLayoutCenter(true).unwrap());
    defer item.deinit();
...
test "Canvas DragSourceMove" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setDragSourceMove(true).unwrap());
    defer item.deinit();
...
test "Canvas Visible" {
    ...
    var item = try (iup.Canvas.init().setVisible(true).unwrap());
    defer item.deinit();
...
test "Canvas LineX" {
    ...
    var item = try (iup.Canvas.init().setLineX(3.14).unwrap());
    defer item.deinit();
...
test "Canvas Cursor" {
    ...
    var item = try (iup.Canvas.init().setCursor("Hello").unwrap());
    defer item.deinit();
...
test "Canvas LineY" {
    ...
    var item = try (iup.Canvas.init().setLineY(3.14).unwrap());
    defer item.deinit();
...
test "Canvas DrawLineWidth" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setDrawLineWidth(42).unwrap());
    defer item.deinit();
...
test "Canvas DragDrop" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setDragDrop(true).unwrap());
    defer item.deinit();
...
test "Canvas DrawAntialias" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setDrawAntialias(42).unwrap());
    defer item.deinit();
...
test "Canvas Theme" {
    ...
    var item = try (iup.Canvas.init().setTheme("Hello").unwrap());
    defer item.deinit();
...
test "Canvas DragCursorCopy" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setDragCursorCopy("Hello").unwrap());
    defer item.deinit();
...
test "Canvas HtTransparent" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setHtTransparent(true).unwrap());
    defer item.deinit();
...
test "Canvas Expand" {
    ...
    var item = try (iup.Canvas.init().setExpand(.Yes).unwrap());
    defer item.deinit();
...
test "Canvas DrawFont" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setDrawFont("Hello").unwrap());
    defer item.deinit();
...
test "Canvas Size" {
    ...
    var item = try (iup.Canvas.init().setSize(9, 10).unwrap());
    defer item.deinit();
...
test "Canvas PosX" {
    ...
    var item = try (iup.Canvas.init().setPosX(3.14).unwrap());
    defer item.deinit();
...
test "Canvas PosY" {
    ...
    var item = try (iup.Canvas.init().setPosY(3.14).unwrap());
    defer item.deinit();
...
test "Canvas YMin" {
    ...
    var item = try (iup.Canvas.init().setYMin(42).unwrap());
    defer item.deinit();
...
test "Canvas DrawMakeInactive" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setDrawMakeInactive(true).unwrap());
    defer item.deinit();
...
test "Canvas FontSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setFontSize(42).unwrap());
    defer item.deinit();
...
test "Canvas DropTypes" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setDropTypes("Hello").unwrap());
    defer item.deinit();
...
test "Canvas UserSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setUserSize(9, 10).unwrap());
    defer item.deinit();
...
test "Canvas TipDelay" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setTipDelay(42).unwrap());
    defer item.deinit();
...
test "Canvas DragStart" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setDragStart(9, 10).unwrap());
    defer item.deinit();
...
test "Canvas XAutoHide" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setXAutoHide(true).unwrap());
    defer item.deinit();
...
test "Canvas PropagateFocus" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setPropagateFocus(true).unwrap());
    defer item.deinit();
...
test "Canvas XMax" {
    ...
    var item = try (iup.Canvas.init().setXMax(42).unwrap());
    defer item.deinit();
...
test "Canvas BgColor" {
    ...
    var item = try (iup.Canvas.init().setBgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "Canvas TipBalloonTitle" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setTipBalloonTitle("Hello").unwrap());
    defer item.deinit();
...
test "Canvas DropTarget" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setDropTarget(true).unwrap());
    defer item.deinit();
...
test "Canvas DX" {
    ...
    var item = try (iup.Canvas.init().setDX(3.14).unwrap());
    defer item.deinit();
...
test "Canvas DY" {
    ...
    var item = try (iup.Canvas.init().setDY(3.14).unwrap());
    defer item.deinit();
...
test "Canvas DrawTextEllipsis" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setDrawTextEllipsis(true).unwrap());
    defer item.deinit();
...
test "Canvas DragSource" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setDragSource(true).unwrap());
    defer item.deinit();
...
test "Canvas DrawTextClip" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setDrawTextClip(true).unwrap());
    defer item.deinit();
...
test "Canvas Floating" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setFloating(.Yes).unwrap());
    defer item.deinit();
...
test "Canvas NormalizerGroup" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setNormalizerGroup("Hello").unwrap());
    defer item.deinit();
...
test "Canvas RasterSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setRasterSize(9, 10).unwrap());
    defer item.deinit();
...
test "Canvas TipFgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setTipFgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "Canvas ControlId" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setControlId(42).unwrap());
    defer item.deinit();
...
test "Canvas FontFace" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setFontFace("Hello").unwrap());
    defer item.deinit();
...
test "Canvas DrawColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setDrawColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "Canvas DrawTextOrientation" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setDrawTextOrientation(3.14).unwrap());
    defer item.deinit();
...
test "Canvas DrawBgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setDrawBgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "Canvas Name" {
    ...
    var item = try (iup.Canvas.init().setName("Hello").unwrap());
    defer item.deinit();
...
test "Canvas BackingStore" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setBackingStore(true).unwrap());
    defer item.deinit();
...
test "Canvas TipBalloonTitleIcon" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setTipBalloonTitleIcon(true).unwrap());
    defer item.deinit();
...
test "Canvas YAutoHide" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setYAutoHide(true).unwrap());
    defer item.deinit();
...
test "Canvas DrawStyle" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setDrawStyle(.Fill).unwrap());
    defer item.deinit();
...
test "Canvas Active" {
    ...
    var item = try (iup.Canvas.init().setActive(true).unwrap());
    defer item.deinit();
...
test "Canvas TipVisible" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setTipVisible(true).unwrap());
    defer item.deinit();
...
test "Canvas YMax" {
    ...
    var item = try (iup.Canvas.init().setYMax(42).unwrap());
    defer item.deinit();
...
test "Canvas ExpandWeight" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setExpandWeight(3.14).unwrap());
    defer item.deinit();
...
test "Canvas MinSize" {
    ...
    var item = try (iup.Canvas.init().setMinSize(9, 10).unwrap());
    defer item.deinit();
...
test "Canvas NTheme" {
    ...
    var item = try (iup.Canvas.init().setNTheme("Hello").unwrap());
    defer item.deinit();
...
test "Canvas DragTypes" {
    ...
    var item = try (iup.Canvas.init().setDragTypes("Hello").unwrap());
    defer item.deinit();
...
test "Canvas WheelDropFocus" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setWheelDropFocus(true).unwrap());
    defer item.deinit();
...
test "Canvas FontStyle" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setFontStyle("Hello").unwrap());
    defer item.deinit();
...
test "Canvas Touch" {
    ...
    var item = try (iup.Canvas.init().setTouch(true).unwrap());
    defer item.deinit();
...
test "Canvas DragCursor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Canvas.init().setDragCursor("Hello").unwrap());
    defer item.deinit();
...
test "Canvas Font" {
    ...
    var item = try (iup.Canvas.init().setFont("Hello").unwrap());
    defer item.deinit();
