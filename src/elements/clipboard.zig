...
pub const Clipboard = opaque {
    ...
    pub const Initializer = struct {
        ...
        /// If set to NULL clears the clipboard data.
        /// (GTK 2.6)
        pub fn image(self: Initializer, arg: anytype) Initializer {
            if (self.last_error) |_| return self;
        ...
        pub fn imageHandleName(self: Initializer, arg: [:0]const u8) Initializer {
            if (self.last_error) |_| return self;
    ...
    /// If set to NULL clears the clipboard data.
    /// (GTK 2.6)
    pub fn image(self: *Self, arg: anytype) !void {
        try interop.validateHandle(.Image, arg);
        interop.setHandleAttribute(self, "IMAGE", .{}, arg);
    }

    pub fn imageHandleName(self: *Self, arg: [:0]const u8) void {
