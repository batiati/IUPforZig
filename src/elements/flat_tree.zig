...
/// It behaves like IupFlatTree but it does not depends on the native system.
...
pub const FlatTree = opaque {
    ...
    pub const Initializer = struct {
        ...
        pub fn setTitleFontStyle(self: *Initializer, index: i32, arg: [:0]const u8) Initializer {
            c.setStrAttribute(self.ref, "TITLEFONTSTYLE", index, void, arg);
            return self.*;
        }

        pub fn setUserData(self: *Initializer, comptime T: type, index: i32, arg: ?*T) Initializer {
            c.setPtrAttribute(T, self.ref, "USERDATA", index, void, arg);
            return self.*;
        }
        ...
        pub fn setToggleVisible(self: *Initializer, index: i32, arg: bool) Initializer {
            c.setBoolAttribute(self.ref, "TOGGLEVISIBLE", index, void, arg);
            return self.*;
        }
        ...
        pub fn setTitleFont(self: *Initializer, index: i32, arg: [:0]const u8) Initializer {
            c.setStrAttribute(self.ref, "TITLEFONT", index, void, arg);
            return self.*;
        }
        ...
        pub fn rename(self: *Initializer) Initializer {
            c.setStrAttribute(self.ref, "RENAME", void, void, null);
            return self.*;
        }
        ...
        pub fn setState(self: *Initializer, index: i32, arg: ?State) Initializer {
            if (arg) |value| switch (value) {
                .Expanded => c.setStrAttribute(self.ref, "STATE", index, void, "EXPANDED"),
                .Collapsed => c.setStrAttribute(self.ref, "STATE", index, void, "COLLAPSED"),
            } else {
                c.clearAttribute(self.ref, "STATE", index, void);
            }
            return self.*;
        }
        ...
        pub fn setColor(self: *Initializer, index: i32, rgb: iup.Rgb) Initializer {
            c.setRgb(self.ref, "COLOR", index, void, rgb);
            return self.*;
        }
        ...
        pub fn setShowToggle(self: *Initializer, arg: bool) Initializer {
            c.setBoolAttribute(self.ref, "SHOWTOGGLE", void, void, arg);
            return self.*;
        }
        ...
        pub fn setShowRename(self: *Initializer, arg: bool) Initializer {
            c.setBoolAttribute(self.ref, "SHOWRENAME", void, void, arg);
            return self.*;
        }
        ...
        pub fn setBackColor(self: *Initializer, index: i32, rgb: iup.Rgb) Initializer {
            c.setRgb(self.ref, "BACKCOLOR", index, void, rgb);
            return self.*;
        }
        ...
        pub fn expandAll(self: *Initializer) Initializer {
            c.setStrAttribute(self.ref, "EXPANDALL", void, void, null);
            return self.*;
        }
        ...
        pub fn setRenameCaret(self: *Initializer, arg: [:0]const u8) Initializer {
            c.setStrAttribute(self.ref, "RENAMECARET", void, void, arg);
            return self.*;
        }
        ...
        pub fn setTitle(self: *Initializer, index: i32, arg: [:0]const u8) Initializer {
            c.setStrAttribute(self.ref, "TITLE", index, void, arg);
            return self.*;
        }
        ...
        pub fn setToggleValue(self: *Initializer, index: i32, arg: ?ToggleValue) Initializer {
            if (arg) |value| switch (value) {
                .On => c.setStrAttribute(self.ref, "TOGGLEVALUE", index, void, "ON"),
                .Off => c.setStrAttribute(self.ref, "TOGGLEVALUE", index, void, "OFF"),
                .NotDef => c.setStrAttribute(self.ref, "TOGGLEVALUE", index, void, "NOTDEF"),
            } else {
                c.clearAttribute(self.ref, "TOGGLEVALUE", index, void);
            }
            return self.*;
        }
        ...
        pub fn setTitleFontSize(self: *Initializer, index: i32, arg: i32) Initializer {
            c.setIntAttribute(self.ref, "TITLEFONTSIZE", index, void, arg);
            return self.*;
        }

        pub fn setRenameSelection(self: *Initializer, arg: [:0]const u8) Initializer {
            c.setStrAttribute(self.ref, "RENAMESELECTION", void, void, arg);
            return self.*;
        }
    ...
    pub fn getTitleFontStyle(self: *Self, index: i32) [:0]const u8 {
        return c.getStrAttribute(self, "TITLEFONTSTYLE", index, void);
    }

    pub fn setTitleFontStyle(self: *Self, index: i32, arg: [:0]const u8) void {
        c.setStrAttribute(self, "TITLEFONTSTYLE", index, void, arg);
    }

    pub fn getUserData(self: *Self, comptime T: type, index: i32) ?*T {
        return c.getPtrAttribute(T, self, "USERDATA", index, void);
    }

    pub fn setUserData(self: *Self, comptime T: type, index: i32, arg: ?*T) void {
        c.setPtrAttribute(T, self, "USERDATA", index, void, arg);
    }
    ...
    pub fn getRootCount(self: *Self) i32 {
        return c.getIntAttribute(self, "ROOTCOUNT", void, void);
    }
    ...
    pub fn getToggleVisible(self: *Self, index: i32) bool {
        return c.getBoolAttribute(self, "TOGGLEVISIBLE", index, void);
    }

    pub fn setToggleVisible(self: *Self, index: i32, arg: bool) void {
        c.setBoolAttribute(self, "TOGGLEVISIBLE", index, void, arg);
    }
    ...
    pub fn getTitleFont(self: *Self, index: i32) [:0]const u8 {
        return c.getStrAttribute(self, "TITLEFONT", index, void);
    }

    pub fn setTitleFont(self: *Self, index: i32, arg: [:0]const u8) void {
        c.setStrAttribute(self, "TITLEFONT", index, void, arg);
    }
    ...
    pub fn rename(self: *Self) void {
        c.setStrAttribute(self, "RENAME", void, void, null);
    }
    ...
    pub fn getTotalChildCount(self: *Self, index: i32) i32 {
        return c.getIntAttribute(self, "TOTALCHILDCOUNT", index, void);
    }
    ...
    pub fn getState(self: *Self, index: i32) ?State {
        var ret = c.getStrAttribute(self, "STATE", index, void);
    ...
    pub fn setState(self: *Self, index: i32, arg: ?State) void {
        if (arg) |value| switch (value) {
            .Expanded => c.setStrAttribute(self, "STATE", index, void, "EXPANDED"),
            .Collapsed => c.setStrAttribute(self, "STATE", index, void, "COLLAPSED"),
        } else {
            c.clearAttribute(self, "STATE", index, void);
        }
    }
    ...
    pub fn getColor(self: *Self, index: i32) ?iup.Rgb {
        return c.getRgb(self, "COLOR", index, void);
    }

    pub fn setColor(self: *Self, index: i32, rgb: iup.Rgb) void {
        c.setRgb(self, "COLOR", index, void, rgb);
    }
    ...
    pub fn getShowToggle(self: *Self) bool {
        return c.getBoolAttribute(self, "SHOWTOGGLE", void, void);
    }

    pub fn setShowToggle(self: *Self, arg: bool) void {
        c.setBoolAttribute(self, "SHOWTOGGLE", void, void, arg);
    }
    ...
    pub fn getShowRename(self: *Self) bool {
        return c.getBoolAttribute(self, "SHOWRENAME", void, void);
    }

    pub fn setShowRename(self: *Self, arg: bool) void {
        c.setBoolAttribute(self, "SHOWRENAME", void, void, arg);
    }
    ...
    pub fn getBackColor(self: *Self, index: i32) ?iup.Rgb {
        return c.getRgb(self, "BACKCOLOR", index, void);
    }

    pub fn setBackColor(self: *Self, index: i32, rgb: iup.Rgb) void {
        c.setRgb(self, "BACKCOLOR", index, void, rgb);
    }
    ...
    pub fn expandAll(self: *Self) void {
        c.setStrAttribute(self, "EXPANDALL", void, void, null);
    }
    ...
    pub fn getRenameCaret(self: *Self) [:0]const u8 {
        return c.getStrAttribute(self, "RENAMECARET", void, void);
    }

    pub fn setRenameCaret(self: *Self, arg: [:0]const u8) void {
        c.setStrAttribute(self, "RENAMECARET", void, void, arg);
    }
    ...
    pub fn getTitle(self: *Self, index: i32) [:0]const u8 {
        return c.getStrAttribute(self, "TITLE", index, void);
    }
    ...
    pub fn setTitle(self: *Self, index: i32, arg: [:0]const u8) void {
        c.setStrAttribute(self, "TITLE", index, void, arg);
    }
    ...
    pub fn getToggleValue(self: *Self, index: i32) ?ToggleValue {
        var ret = c.getStrAttribute(self, "TOGGLEVALUE", index, void);
    ...
    pub fn setToggleValue(self: *Self, index: i32, arg: ?ToggleValue) void {
        if (arg) |value| switch (value) {
            .On => c.setStrAttribute(self, "TOGGLEVALUE", index, void, "ON"),
            .Off => c.setStrAttribute(self, "TOGGLEVALUE", index, void, "OFF"),
            .NotDef => c.setStrAttribute(self, "TOGGLEVALUE", index, void, "NOTDEF"),
        } else {
            c.clearAttribute(self, "TOGGLEVALUE", index, void);
        }
    }
    ...
    pub fn getTitleFontSize(self: *Self, index: i32) i32 {
        return c.getIntAttribute(self, "TITLEFONTSIZE", index, void);
    }

    pub fn setTitleFontSize(self: *Self, index: i32, arg: i32) void {
        c.setIntAttribute(self, "TITLEFONTSIZE", index, void, arg);
    }

    pub fn getRenameSelection(self: *Self) [:0]const u8 {
        return c.getStrAttribute(self, "RENAMESELECTION", void, void);
    }

    pub fn setRenameSelection(self: *Self, arg: [:0]const u8) void {
        c.setStrAttribute(self, "RENAMESELECTION", void, void, arg);
    }
    ...
    pub fn getShowDragDrop(self: *Self) bool {
        return c.getBoolAttribute(self, "SHOWDRAGDROP", void, void);
    }
    ...
    pub fn setShowDragDrop(self: *Self, arg: bool) void {
        c.setBoolAttribute(self, "SHOWDRAGDROP", void, void, arg);
    }
...
test "FlatTree DrawTextLayoutCenter" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setDrawTextLayoutCenter(true).unwrap());
    defer item.deinit();
...
test "FlatTree DragTypes" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setDragTypes("Hello").unwrap());
    defer item.deinit();
...
test "FlatTree XMax" {
    ...
    var item = try (iup.FlatTree.init().setXMax(42).unwrap());
    defer item.deinit();
...
test "FlatTree IconSpacing" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setIconSpacing(42).unwrap());
    defer item.deinit();
...
test "FlatTree Size" {
    ...
    var item = try (iup.FlatTree.init().setSize(9, 10).unwrap());
    defer item.deinit();
...
test "FlatTree TipFgColor" {
    ...
    var item = try (iup.FlatTree.init().setTipFgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatTree Expand" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setExpand(.Yes).unwrap());
    defer item.deinit();
...
test "FlatTree DrawTextOrientation" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setDrawTextOrientation(3.14).unwrap());
    defer item.deinit();
...
test "FlatTree TitleFontStyle" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setTitleFontStyle(0, "Hello").unwrap());
    defer item.deinit();
...
test "FlatTree DrawTextAlignment" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setDrawTextAlignment(.ACenter).unwrap());
    defer item.deinit();
...
test "FlatTree DragSource" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setDragSource(true).unwrap());
    defer item.deinit();
...
test "FlatTree DrawColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setDrawColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatTree ArrowImages" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setArrowImages(42).unwrap());
    defer item.deinit();
...
test "FlatTree DrawLineWidth" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setDrawLineWidth(42).unwrap());
    defer item.deinit();
...
test "FlatTree UserSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setUserSize(9, 10).unwrap());
    defer item.deinit();
...
test "FlatTree XMin" {
    ...
    var item = try (iup.FlatTree.init().setXMin(42).unwrap());
    defer item.deinit();
...
test "FlatTree DrawTextEllipsis" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setDrawTextEllipsis(true).unwrap());
    defer item.deinit();
...
test "FlatTree ToggleVisible" {
    ...
    var item = try (iup.FlatTree.init().setToggleVisible(0, true).unwrap());
    defer item.deinit();
...
test "FlatTree TextPsColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setTextPsColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatTree ControlId" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setControlId(42).unwrap());
    defer item.deinit();
...
test "FlatTree FocusFeedback" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setFocusFeedback(true).unwrap());
    defer item.deinit();
...
test "FlatTree BorderColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setBorderColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatTree Border" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setBorder(true).unwrap());
    defer item.deinit();
...
test "FlatTree CanFocus" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setCanFocus(true).unwrap());
    defer item.deinit();
...
test "FlatTree BackImageZoom" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setBackImageZoom(true).unwrap());
    defer item.deinit();
...
test "FlatTree DrawTextClip" {
    ...
    var item = try (iup.FlatTree.init().setDrawTextClip(true).unwrap());
    defer item.deinit();
...
test "FlatTree Theme" {
    ...
    var item = try (iup.FlatTree.init().setTheme("Hello").unwrap());
    defer item.deinit();
...
test "FlatTree Visible" {
    ...
    var item = try (iup.FlatTree.init().setVisible(true).unwrap());
    defer item.deinit();
...
test "FlatTree BgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setBgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatTree RasterSize" {
    ...
    var item = try (iup.FlatTree.init().setRasterSize(9, 10).unwrap());
    defer item.deinit();
...
test "FlatTree DrawStyle" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setDrawStyle(.Fill).unwrap());
    defer item.deinit();
...
test "FlatTree DropTarget" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setDropTarget(true).unwrap());
    defer item.deinit();
...
test "FlatTree TitleFont" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setTitleFont(0, "Hello").unwrap());
    defer item.deinit();
...
test "FlatTree DrawMakeInactive" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setDrawMakeInactive(true).unwrap());
    defer item.deinit();
...
test "FlatTree DragStart" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setDragStart(9, 10).unwrap());
    defer item.deinit();
...
test "FlatTree DX" {
    ...
    var item = try (iup.FlatTree.init().setDX(3.14).unwrap());
    defer item.deinit();
...
test "FlatTree DY" {
    ...
    var item = try (iup.FlatTree.init().setDY(3.14).unwrap());
    defer item.deinit();
...
test "FlatTree Position" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setPosition(9, 10).unwrap());
    defer item.deinit();
...
test "FlatTree MinSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setMinSize(9, 10).unwrap());
    defer item.deinit();
...
test "FlatTree LineX" {
    ...
    var item = try (iup.FlatTree.init().setLineX(3.14).unwrap());
    defer item.deinit();
...
test "FlatTree LineY" {
    ...
    var item = try (iup.FlatTree.init().setLineY(3.14).unwrap());
    defer item.deinit();
...
test "FlatTree DropTypes" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setDropTypes("Hello").unwrap());
    defer item.deinit();
...
test "FlatTree HandleName" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setHandleName("Hello").unwrap());
    defer item.deinit();
...
test "FlatTree FontFace" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setFontFace("Hello").unwrap());
    defer item.deinit();
...
test "FlatTree State" {
    ...
    var item = try (iup.FlatTree.init().setState(0, .Expanded).unwrap());
    defer item.deinit();
...
test "FlatTree MaxSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setMaxSize(9, 10).unwrap());
    defer item.deinit();
...
test "FlatTree Color" {
    ...
    var item = try (iup.FlatTree.init().setColor(0, .{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatTree ItemTip" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setItemTip(0, "Hello").unwrap());
    defer item.deinit();
...
test "FlatTree FontStyle" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setFontStyle("Hello").unwrap());
    defer item.deinit();
...
test "FlatTree Font" {
    ...
    var item = try (iup.FlatTree.init().setFont("Hello").unwrap());
    defer item.deinit();
...
test "FlatTree ShowToggle" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setShowToggle(true).unwrap());
    defer item.deinit();
...
test "FlatTree WheelDropFocus" {
    ...
    var item = try (iup.FlatTree.init().setWheelDropFocus(true).unwrap());
    defer item.deinit();
...
test "FlatTree HtTransparent" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setHtTransparent(true).unwrap());
    defer item.deinit();
...
test "FlatTree TipBalloonTitleIcon" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setTipBalloonTitleIcon(true).unwrap());
    defer item.deinit();
...
test "FlatTree DrawUsedIRect2d" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setDrawUsedIRect2d(true).unwrap());
    defer item.deinit();
...
test "FlatTree FontSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setFontSize(42).unwrap());
    defer item.deinit();
...
test "FlatTree DrawAntialias" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setDrawAntialias(42).unwrap());
    defer item.deinit();
...
test "FlatTree YMax" {
    ...
    var item = try (iup.FlatTree.init().setYMax(42).unwrap());
    defer item.deinit();
...
test "FlatTree NTheme" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setNTheme("Hello").unwrap());
    defer item.deinit();
...
test "FlatTree DragSourceMove" {
    ...
    var item = try (iup.FlatTree.init().setDragSourceMove(true).unwrap());
    defer item.deinit();
...
test "FlatTree Active" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setActive(true).unwrap());
    defer item.deinit();
...
test "FlatTree BorderWidth" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setBorderWidth(42).unwrap());
    defer item.deinit();
...
test "FlatTree FgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setFgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatTree HlColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setHlColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatTree CSpacing" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setCSpacing(42).unwrap());
    defer item.deinit();
...
test "FlatTree PosX" {
    ...
    var item = try (iup.FlatTree.init().setPosX(3.14).unwrap());
    defer item.deinit();
...
test "FlatTree PosY" {
    ...
    var item = try (iup.FlatTree.init().setPosY(3.14).unwrap());
    defer item.deinit();
...
test "FlatTree ShowRename" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setShowRename(true).unwrap());
    defer item.deinit();
...
test "FlatTree TipVisible" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setTipVisible(true).unwrap());
    defer item.deinit();
...
test "FlatTree DrawFont" {
    ...
    var item = try (iup.FlatTree.init().setDrawFont("Hello").unwrap());
    defer item.deinit();
...
test "FlatTree ExpandWeight" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setExpandWeight(3.14).unwrap());
    defer item.deinit();
...
test "FlatTree TipBgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setTipBgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatTree DrawBgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setDrawBgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatTree YMin" {
    ...
    var item = try (iup.FlatTree.init().setYMin(42).unwrap());
    defer item.deinit();
...
test "FlatTree NormalizerGroup" {
    ...
    var item = try (iup.FlatTree.init().setNormalizerGroup("Hello").unwrap());
    defer item.deinit();
...
test "FlatTree ScrollBar" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setScrollBar(true).unwrap());
    defer item.deinit();
...
test "FlatTree BackColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setBackColor(0, .{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();

    var ret = item.getBackColor(0);

    try std.testing.expect(ret != null and ret.?.r == 9 and ret.?.g == 10 and ret.?.b == 11);
}

test "FlatTree DropFilesTarget" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setDropFilesTarget(true).unwrap());
    defer item.deinit();
...
test "FlatTree TipBalloonTitle" {
    ...
    var item = try (iup.FlatTree.init().setTipBalloonTitle("Hello").unwrap());
    defer item.deinit();
...
test "FlatTree HlColorAlpha" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setHlColorAlpha(42).unwrap());
    defer item.deinit();
...
test "FlatTree RenameCaret" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setRenameCaret("Hello").unwrap());
    defer item.deinit();
...
test "FlatTree Title" {
    ...
    var item = try (iup.FlatTree.init().setTitle(0, "Hello").unwrap());
    defer item.deinit();
...
test "FlatTree DrawTextWrap" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setDrawTextWrap(true).unwrap());
    defer item.deinit();
...
test "FlatTree Tip" {
    ...
    var item = try (iup.FlatTree.init().setTip("Hello").unwrap());
    defer item.deinit();
...
test "FlatTree DragDrop" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setDragDrop(true).unwrap());
    defer item.deinit();
...
test "FlatTree TipDelay" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setTipDelay(42).unwrap());
    defer item.deinit();
...
test "FlatTree ToggleValue" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setToggleValue(0, .On).unwrap());
    defer item.deinit();
...
test "FlatTree PsColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setPsColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "FlatTree TipBalloon" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setTipBalloon(true).unwrap());
    defer item.deinit();
...
test "FlatTree Floating" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setFloating(.Yes).unwrap());
    defer item.deinit();
...
test "FlatTree Touch" {
    ...
    var item = try (iup.FlatTree.init().setTouch(true).unwrap());
    defer item.deinit();
...
test "FlatTree Name" {
    ...
    var item = try (iup.FlatTree.init().setName("Hello").unwrap());
    defer item.deinit();
...
test "FlatTree TitleFontSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setTitleFontSize(0, 42).unwrap());
    defer item.deinit();
...
test "FlatTree RenameSelection" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setRenameSelection("Hello").unwrap());
    defer item.deinit();
...
test "FlatTree ShowDragDrop" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setShowDragDrop(true).unwrap());
    defer item.deinit();
...
test "FlatTree Spacing" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setSpacing(42).unwrap());
    defer item.deinit();
...
test "FlatTree PropagateFocus" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setPropagateFocus(true).unwrap());
    defer item.deinit();
...
test "FlatTree BackingStore" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatTree.init().setBackingStore(true).unwrap());
    defer item.deinit();
