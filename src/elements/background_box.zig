...
pub const BackgroundBox = opaque {
    pub const CLASS_NAME = "backgroundbox";
    const Self = @This();
    ...
    pub const Initializer = struct {
        ...
        pub fn setCanvasBox(self: *Initializer, arg: bool) Initializer {
            c.setBoolAttribute(self.ref, "CANVASBOX", void, void, arg);
            return self.*;
        }
        ...
        /// Default No.
        /// (since 3.20)
        pub fn setDecoration(self: *Initializer, arg: bool) Initializer {
            c.setBoolAttribute(self.ref, "DECORATION", void, void, arg);
            return self.*;
        }
        ...
        /// (since 3.20)
        pub fn setDecorOffset(self: *Initializer, width: ?i32, height: ?i32) Initializer {
            var buffer: [128]u8 = undefined;
            var value = Size.intIntToString(&buffer, width, height);
            c.setStrAttribute(self.ref, "DECOROFFSET", void, void, value);
            return self.*;
        }
        ...
        /// Used only when DECORATION=Yes.
        /// (since 3.20)
        pub fn setDecorSize(self: *Initializer, width: ?i32, height: ?i32) Initializer {
            var buffer: [128]u8 = undefined;
            var value = Size.intIntToString(&buffer, width, height);
            c.setStrAttribute(self.ref, "DECORSIZE", void, void, value);
            return self.*;
        }
    ...
    pub fn getCanvasBox(self: *Self) bool {
        return c.getBoolAttribute(self, "CANVASBOX", void, void);
    }
    ...
    pub fn setCanvasBox(self: *Self, arg: bool) void {
        c.setBoolAttribute(self, "CANVASBOX", void, void, arg);
    }
    ...
    pub fn getDecoration(self: *Self) bool {
        return c.getBoolAttribute(self, "DECORATION", void, void);
    }
    ...
    /// Default No.
    /// (since 3.20)
    pub fn setDecoration(self: *Self, arg: bool) void {
        c.setBoolAttribute(self, "DECORATION", void, void, arg);
    }
    ...
    /// Used only when DECORATION=Yes.
    /// (since 3.20)
    pub fn getDecorOffset(self: *Self) Size {
        var str = c.getStrAttribute(self, "DECOROFFSET", void, void);
        return Size.parse(str);
    }
    ...
    /// Used only when DECORATION=Yes.
    /// (since 3.20)
    pub fn setDecorOffset(self: *Self, width: ?i32, height: ?i32) void {
        var buffer: [128]u8 = undefined;
        var value = Size.intIntToString(&buffer, width, height);
        c.setStrAttribute(self, "DECOROFFSET", void, void, value);
    }
    ...
    /// Used only when DECORATION=Yes.
    /// (since 3.20)
    pub fn getDecorSize(self: *Self) Size {
        var str = c.getStrAttribute(self, "DECORSIZE", void, void);
        return Size.parse(str);
    }
    ...
    /// Used only when DECORATION=Yes.
    /// (since 3.20)
    pub fn setDecorSize(self: *Self, width: ?i32, height: ?i32) void {
        var buffer: [128]u8 = undefined;
        var value = Size.intIntToString(&buffer, width, height);
        c.setStrAttribute(self, "DECORSIZE", void, void, value);
    }
...
test "BackgroundBox TipBalloon" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setTipBalloon(true).unwrap());
    defer item.deinit();
...
test "BackgroundBox HandleName" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setHandleName("Hello").unwrap());
    defer item.deinit();
...
test "BackgroundBox CanvasBox" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setCanvasBox(true).unwrap());
    defer item.deinit();

    var ret = item.getCanvasBox();

    try std.testing.expect(ret == true);
}

test "BackgroundBox TipBgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setTipBgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "BackgroundBox Decoration" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setDecoration(true).unwrap());
    defer item.deinit();

    var ret = item.getDecoration();

    try std.testing.expect(ret == true);
}

test "BackgroundBox XMin" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setXMin(42).unwrap());
    defer item.deinit();
...
test "BackgroundBox BackColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setBackColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "BackgroundBox MaxSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setMaxSize(9, 10).unwrap());
    defer item.deinit();
...
test "BackgroundBox DrawTextWrap" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setDrawTextWrap(true).unwrap());
    defer item.deinit();
...
test "BackgroundBox DrawUsedIRect2d" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setDrawUsedIRect2d(true).unwrap());
    defer item.deinit();
...
test "BackgroundBox Position" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setPosition(9, 10).unwrap());
    defer item.deinit();
...
test "BackgroundBox DropFilesTarget" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setDropFilesTarget(true).unwrap());
    defer item.deinit();
...
test "BackgroundBox DrawTextAlignment" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setDrawTextAlignment(.ACenter).unwrap());
    defer item.deinit();
...
test "BackgroundBox Tip" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setTip("Hello").unwrap());
    defer item.deinit();
...
test "BackgroundBox DrawTextLayoutCenter" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setDrawTextLayoutCenter(true).unwrap());
    defer item.deinit();
...
test "BackgroundBox CanFocus" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setCanFocus(true).unwrap());
    defer item.deinit();
...
test "BackgroundBox DragSourceMove" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setDragSourceMove(true).unwrap());
    defer item.deinit();
...
test "BackgroundBox Visible" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setVisible(true).unwrap());
    defer item.deinit();
...
test "BackgroundBox LineX" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setLineX(3.14).unwrap());
    defer item.deinit();
...
test "BackgroundBox Cursor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setCursor("Hello").unwrap());
    defer item.deinit();
...
test "BackgroundBox LineY" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setLineY(3.14).unwrap());
    defer item.deinit();
...
test "BackgroundBox DrawLineWidth" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setDrawLineWidth(42).unwrap());
    defer item.deinit();
...
test "BackgroundBox DragDrop" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setDragDrop(true).unwrap());
    defer item.deinit();
...
test "BackgroundBox DrawAntialias" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setDrawAntialias(42).unwrap());
    defer item.deinit();
...
test "BackgroundBox Theme" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setTheme("Hello").unwrap());
    defer item.deinit();
...
test "BackgroundBox DragCursorCopy" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setDragCursorCopy("Hello").unwrap());
    defer item.deinit();
...
test "BackgroundBox HtTransparent" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setHtTransparent(true).unwrap());
    defer item.deinit();
...
test "BackgroundBox ChildOffset" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setChildOffset(9, 10).unwrap());
    defer item.deinit();
...
test "BackgroundBox Expand" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setExpand(.Yes).unwrap());
    defer item.deinit();
...
test "BackgroundBox DrawFont" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setDrawFont("Hello").unwrap());
    defer item.deinit();
...
test "BackgroundBox Size" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setSize(9, 10).unwrap());
    defer item.deinit();
...
test "BackgroundBox PosX" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setPosX(3.14).unwrap());
    defer item.deinit();
...
test "BackgroundBox PosY" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setPosY(3.14).unwrap());
    defer item.deinit();
...
test "BackgroundBox YMin" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setYMin(42).unwrap());
    defer item.deinit();
...
test "BackgroundBox DrawMakeInactive" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setDrawMakeInactive(true).unwrap());
    defer item.deinit();
...
test "BackgroundBox FontSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setFontSize(42).unwrap());
    defer item.deinit();
...
test "BackgroundBox DropTypes" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setDropTypes("Hello").unwrap());
    defer item.deinit();
...
test "BackgroundBox UserSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setUserSize(9, 10).unwrap());
    defer item.deinit();
...
test "BackgroundBox TipDelay" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setTipDelay(42).unwrap());
    defer item.deinit();
...
test "BackgroundBox ScrollBar" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setScrollBar(true).unwrap());
    defer item.deinit();
...
test "BackgroundBox DragStart" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setDragStart(9, 10).unwrap());
    defer item.deinit();
...
test "BackgroundBox XAutoHide" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setXAutoHide(true).unwrap());
    defer item.deinit();
...
test "BackgroundBox PropagateFocus" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setPropagateFocus(true).unwrap());
    defer item.deinit();
...
test "BackgroundBox XMax" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setXMax(42).unwrap());
    defer item.deinit();
...
test "BackgroundBox BgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setBgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "BackgroundBox TipBalloonTitle" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setTipBalloonTitle("Hello").unwrap());
    defer item.deinit();
...
test "BackgroundBox DropTarget" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setDropTarget(true).unwrap());
    defer item.deinit();
...
test "BackgroundBox DX" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setDX(3.14).unwrap());
    defer item.deinit();
...
test "BackgroundBox DY" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setDY(3.14).unwrap());
    defer item.deinit();
...
test "BackgroundBox DrawTextEllipsis" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setDrawTextEllipsis(true).unwrap());
    defer item.deinit();
...
test "BackgroundBox DragSource" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setDragSource(true).unwrap());
    defer item.deinit();
...
test "BackgroundBox DrawTextClip" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setDrawTextClip(true).unwrap());
    defer item.deinit();
...
test "BackgroundBox Floating" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setFloating(.Yes).unwrap());
    defer item.deinit();
...
test "BackgroundBox NormalizerGroup" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setNormalizerGroup("Hello").unwrap());
    defer item.deinit();
...
test "BackgroundBox DecorOffset" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setDecorOffset(9, 10).unwrap());
    defer item.deinit();

    var ret = item.getDecorOffset();

    try std.testing.expect(ret.width != null and ret.width.? == 9 and ret.height != null and ret.height.? == 10);
}

test "BackgroundBox RasterSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setRasterSize(9, 10).unwrap());
    defer item.deinit();
...
test "BackgroundBox TipFgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setTipFgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "BackgroundBox ControlId" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setControlId(42).unwrap());
    defer item.deinit();
...
test "BackgroundBox FontFace" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setFontFace("Hello").unwrap());
    defer item.deinit();
...
test "BackgroundBox DrawColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setDrawColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "BackgroundBox DrawTextOrientation" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setDrawTextOrientation(3.14).unwrap());
    defer item.deinit();
...
test "BackgroundBox DrawBgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setDrawBgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "BackgroundBox Name" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setName("Hello").unwrap());
    defer item.deinit();
...
test "BackgroundBox BackingStore" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setBackingStore(true).unwrap());
    defer item.deinit();
...
test "BackgroundBox TipBalloonTitleIcon" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setTipBalloonTitleIcon(true).unwrap());
    defer item.deinit();
...
test "BackgroundBox YAutoHide" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setYAutoHide(true).unwrap());
    defer item.deinit();
...
test "BackgroundBox DrawStyle" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setDrawStyle(.Fill).unwrap());
    defer item.deinit();
...
test "BackgroundBox BackImageZoom" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setBackImageZoom(true).unwrap());
    defer item.deinit();
...
test "BackgroundBox Active" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setActive(true).unwrap());
    defer item.deinit();
...
test "BackgroundBox TipVisible" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setTipVisible(true).unwrap());
    defer item.deinit();
...
test "BackgroundBox YMax" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setYMax(42).unwrap());
    defer item.deinit();
...
test "BackgroundBox DecorSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setDecorSize(9, 10).unwrap());
    defer item.deinit();

    var ret = item.getDecorSize();

    try std.testing.expect(ret.width != null and ret.width.? == 9 and ret.height != null and ret.height.? == 10);
}

test "BackgroundBox BackImage" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setBackImage("Hello").unwrap());
    defer item.deinit();
...
test "BackgroundBox ExpandWeight" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setExpandWeight(3.14).unwrap());
    defer item.deinit();
...
test "BackgroundBox MinSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setMinSize(9, 10).unwrap());
    defer item.deinit();
...
test "BackgroundBox NTheme" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setNTheme("Hello").unwrap());
    defer item.deinit();
...
test "BackgroundBox DragTypes" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setDragTypes("Hello").unwrap());
    defer item.deinit();
...
test "BackgroundBox WheelDropFocus" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setWheelDropFocus(true).unwrap());
    defer item.deinit();
...
test "BackgroundBox FontStyle" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setFontStyle("Hello").unwrap());
    defer item.deinit();
...
test "BackgroundBox Touch" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setTouch(true).unwrap());
    defer item.deinit();
...
test "BackgroundBox DragCursor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setDragCursor("Hello").unwrap());
    defer item.deinit();
...
test "BackgroundBox Font" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.BackgroundBox.init().setFont("Hello").unwrap());
    defer item.deinit();
