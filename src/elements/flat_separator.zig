...
test "FlatSeparator TipBalloon" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatSeparator.init().setTipBalloon(true).unwrap());
    defer item.deinit();
...
test "FlatSeparator DrawUsedIRect2d" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatSeparator.init().setDrawUsedIRect2d(true).unwrap());
    defer item.deinit();
...
test "FlatSeparator Cursor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatSeparator.init().setCursor("Hello").unwrap());
    defer item.deinit();
...
test "FlatSeparator DrawAntialias" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatSeparator.init().setDrawAntialias(42).unwrap());
    defer item.deinit();
...
test "FlatSeparator DragCursorCopy" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatSeparator.init().setDragCursorCopy("Hello").unwrap());
    defer item.deinit();
...
test "FlatSeparator HtTransparent" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatSeparator.init().setHtTransparent(true).unwrap());
    defer item.deinit();
...
test "FlatSeparator DragStart" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatSeparator.init().setDragStart(9, 10).unwrap());
    defer item.deinit();
...
test "FlatSeparator TipBalloonTitle" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatSeparator.init().setTipBalloonTitle("Hello").unwrap());
    defer item.deinit();
...
test "FlatSeparator ControlId" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatSeparator.init().setControlId(42).unwrap());
    defer item.deinit();
...
test "FlatSeparator TipBalloonTitleIcon" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatSeparator.init().setTipBalloonTitleIcon(true).unwrap());
    defer item.deinit();
...
test "FlatSeparator DragCursor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.FlatSeparator.init().setDragCursor("Hello").unwrap());
    defer item.deinit();
