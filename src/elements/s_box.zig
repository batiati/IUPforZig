...
pub const SBox = opaque {
    ...
    pub const Initializer = struct {
        ...
        pub fn setDirection(self: *Initializer, arg: ?Direction) Initializer {
            if (arg) |value| switch (value) {
                .North => c.setStrAttribute(self.ref, "DIRECTION", .{}, "NORTH"),
                .South => c.setStrAttribute(self.ref, "DIRECTION", .{}, "SOUTH"),
                .West => c.setStrAttribute(self.ref, "DIRECTION", .{}, "WEST"),
                .East => c.setStrAttribute(self.ref, "DIRECTION", .{}, "EAST"),
            } else {
                c.clearAttribute(self.ref, "DIRECTION", .{});
            }
            return self.*;
        }
