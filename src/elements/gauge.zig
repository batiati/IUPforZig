...
pub const Gauge = opaque {
    pub const CLASS_NAME = "gauge";
    const Self = @This();
    ...
    pub const Initializer = struct {
        ...
        /// Can be NULL.
        /// When NULL it will use the parent's background color.
        /// (since 3.28)
        ...
        pub fn setShowText(self: *Initializer, arg: [:0]const u8) Initializer {
            c.setStrAttribute(self.ref, "SHOWTEXT", void, void, arg);
            return self.*;
        }
        ...
        /// If the gauge is dashed the text is never shown.
        /// When ORIENTATION=VERTICAL text is drawn in 90.
    ...
    pub fn getShowText(self: *Self) [:0]const u8 {
        return c.getStrAttribute(self, "SHOWTEXT", void, void);
    }
    ...
    pub fn setShowText(self: *Self, arg: [:0]const u8) void {
        c.setStrAttribute(self, "SHOWTEXT", void, void, arg);
    }
...
test "Gauge FgColor" {
    ...
    var item = try (iup.Gauge.init().setFgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "Gauge TipBalloon" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setTipBalloon(true).unwrap());
    defer item.deinit();
...
test "Gauge HandleName" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setHandleName("Hello").unwrap());
    defer item.deinit();
...
test "Gauge TipBgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setTipBgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "Gauge XMin" {
    ...
    var item = try (iup.Gauge.init().setXMin(42).unwrap());
    defer item.deinit();
...
test "Gauge BackColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setBackColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "Gauge MaxSize" {
    ...
    var item = try (iup.Gauge.init().setMaxSize(9, 10).unwrap());
    defer item.deinit();
...
test "Gauge DrawTextWrap" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setDrawTextWrap(true).unwrap());
    defer item.deinit();
...
test "Gauge DrawUsedIRect2d" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setDrawUsedIRect2d(true).unwrap());
    defer item.deinit();
...
test "Gauge Position" {
    ...
    var item = try (iup.Gauge.init().setPosition(9, 10).unwrap());
    defer item.deinit();
...
test "Gauge DropFilesTarget" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setDropFilesTarget(true).unwrap());
    defer item.deinit();
...
test "Gauge DrawTextAlignment" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setDrawTextAlignment(.ACenter).unwrap());
    defer item.deinit();
...
test "Gauge Tip" {
    ...
    var item = try (iup.Gauge.init().setTip("Hello").unwrap());
    defer item.deinit();
...
test "Gauge DrawTextLayoutCenter" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setDrawTextLayoutCenter(true).unwrap());
    defer item.deinit();
...
test "Gauge CanFocus" {
    ...
    var item = try (iup.Gauge.init().setCanFocus(true).unwrap());
    defer item.deinit();
...
test "Gauge DragSourceMove" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setDragSourceMove(true).unwrap());
    defer item.deinit();
...
test "Gauge Visible" {
    ...
    var item = try (iup.Gauge.init().setVisible(true).unwrap());
    defer item.deinit();
...
test "Gauge LineX" {
    ...
    var item = try (iup.Gauge.init().setLineX(3.14).unwrap());
    defer item.deinit();
...
test "Gauge Cursor" {
    ...
    var item = try (iup.Gauge.init().setCursor("Hello").unwrap());
    defer item.deinit();
...
test "Gauge LineY" {
    ...
    var item = try (iup.Gauge.init().setLineY(3.14).unwrap());
    defer item.deinit();
...
test "Gauge DrawLineWidth" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setDrawLineWidth(42).unwrap());
    defer item.deinit();
...
test "Gauge DragDrop" {
    ...
    var item = try (iup.Gauge.init().setDragDrop(true).unwrap());
    defer item.deinit();
...
test "Gauge DrawAntialias" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setDrawAntialias(42).unwrap());
    defer item.deinit();
...
test "Gauge Theme" {
    ...
    var item = try (iup.Gauge.init().setTheme("Hello").unwrap());
    defer item.deinit();
...
test "Gauge FlatColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setFlatColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "Gauge DragCursorCopy" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setDragCursorCopy("Hello").unwrap());
    defer item.deinit();
...
test "Gauge HtTransparent" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setHtTransparent(true).unwrap());
    defer item.deinit();
...
test "Gauge Expand" {
    ...
    var item = try (iup.Gauge.init().setExpand(.Yes).unwrap());
    defer item.deinit();
...
test "Gauge DrawFont" {
    ...
    var item = try (iup.Gauge.init().setDrawFont("Hello").unwrap());
    defer item.deinit();
...
test "Gauge Size" {
    ...
    var item = try (iup.Gauge.init().setSize(9, 10).unwrap());
    defer item.deinit();
...
test "Gauge Padding" {
    ...
    var item = try (iup.Gauge.init().setPadding(9, 10).unwrap());
    defer item.deinit();
...
test "Gauge PosX" {
    ...
    var item = try (iup.Gauge.init().setPosX(3.14).unwrap());
    defer item.deinit();
...
test "Gauge PosY" {
    ...
    var item = try (iup.Gauge.init().setPosY(3.14).unwrap());
    defer item.deinit();
...
test "Gauge YMin" {
    ...
    var item = try (iup.Gauge.init().setYMin(42).unwrap());
    defer item.deinit();
...
test "Gauge DrawMakeInactive" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setDrawMakeInactive(true).unwrap());
    defer item.deinit();
...
test "Gauge FontSize" {
    ...
    var item = try (iup.Gauge.init().setFontSize(42).unwrap());
    defer item.deinit();
...
test "Gauge Min" {
    ...
    var item = try (iup.Gauge.init().setMin(3.14).unwrap());
    defer item.deinit();
...
test "Gauge DropTypes" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setDropTypes("Hello").unwrap());
    defer item.deinit();
...
test "Gauge UserSize" {
    ...
    var item = try (iup.Gauge.init().setUserSize(9, 10).unwrap());
    defer item.deinit();
...
test "Gauge TipDelay" {
    ...
    var item = try (iup.Gauge.init().setTipDelay(42).unwrap());
    defer item.deinit();
...
test "Gauge ScrollBar" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setScrollBar(true).unwrap());
    defer item.deinit();
...
test "Gauge DragStart" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setDragStart(9, 10).unwrap());
    defer item.deinit();
...
test "Gauge XAutoHide" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setXAutoHide(true).unwrap());
    defer item.deinit();
...
test "Gauge PropagateFocus" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setPropagateFocus(true).unwrap());
    defer item.deinit();
...
test "Gauge XMax" {
    ...
    var item = try (iup.Gauge.init().setXMax(42).unwrap());
    defer item.deinit();
...
test "Gauge BgColor" {
    ...
    var item = try (iup.Gauge.init().setBgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "Gauge TipBalloonTitle" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setTipBalloonTitle("Hello").unwrap());
    defer item.deinit();
...
test "Gauge DropTarget" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setDropTarget(true).unwrap());
    defer item.deinit();
...
test "Gauge DX" {
    ...
    var item = try (iup.Gauge.init().setDX(3.14).unwrap());
    defer item.deinit();
...
test "Gauge DY" {
    ...
    var item = try (iup.Gauge.init().setDY(3.14).unwrap());
    defer item.deinit();
...
test "Gauge DrawTextEllipsis" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setDrawTextEllipsis(true).unwrap());
    defer item.deinit();
...
test "Gauge DragSource" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setDragSource(true).unwrap());
    defer item.deinit();
...
test "Gauge DrawTextClip" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setDrawTextClip(true).unwrap());
    defer item.deinit();
...
test "Gauge Floating" {
    ...
    var item = try (iup.Gauge.init().setFloating(.Yes).unwrap());
    defer item.deinit();
...
test "Gauge NormalizerGroup" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setNormalizerGroup("Hello").unwrap());
    defer item.deinit();
...
test "Gauge RasterSize" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setRasterSize(9, 10).unwrap());
    defer item.deinit();
...
test "Gauge TipFgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setTipFgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "Gauge ControlId" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setControlId(42).unwrap());
    defer item.deinit();
...
test "Gauge FontFace" {
    ...
    var item = try (iup.Gauge.init().setFontFace("Hello").unwrap());
    defer item.deinit();
...
test "Gauge DrawColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setDrawColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "Gauge DrawTextOrientation" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setDrawTextOrientation(3.14).unwrap());
    defer item.deinit();
...
test "Gauge DrawBgColor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setDrawBgColor(.{ .r = 9, .g = 10, .b = 11 }).unwrap());
    defer item.deinit();
...
test "Gauge Name" {
    ...
    var item = try (iup.Gauge.init().setName("Hello").unwrap());
    defer item.deinit();
...
test "Gauge BackingStore" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setBackingStore(true).unwrap());
    defer item.deinit();
...
test "Gauge TipBalloonTitleIcon" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setTipBalloonTitleIcon(true).unwrap());
    defer item.deinit();
...
test "Gauge YAutoHide" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setYAutoHide(true).unwrap());
    defer item.deinit();
...
test "Gauge DrawStyle" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setDrawStyle(.Fill).unwrap());
    defer item.deinit();
...
test "Gauge CPadding" {
    ...
    var item = try (iup.Gauge.init().setCPadding(9, 10).unwrap());
    defer item.deinit();
...
test "Gauge Active" {
    ...
    var item = try (iup.Gauge.init().setActive(true).unwrap());
    defer item.deinit();
...
test "Gauge TipVisible" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setTipVisible(true).unwrap());
    defer item.deinit();
...
test "Gauge YMax" {
    ...
    var item = try (iup.Gauge.init().setYMax(42).unwrap());
    defer item.deinit();
...
test "Gauge ExpandWeight" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setExpandWeight(3.14).unwrap());
    defer item.deinit();
...
test "Gauge MinSize" {
    ...
    var item = try (iup.Gauge.init().setMinSize(9, 10).unwrap());
    defer item.deinit();
...
test "Gauge Max" {
    ...
    var item = try (iup.Gauge.init().setMax(3.14).unwrap());
    defer item.deinit();
...
test "Gauge Flat" {
    ...
    var item = try (iup.Gauge.init().setFlat(true).unwrap());
    defer item.deinit();
...
test "Gauge NTheme" {
    ...
    var item = try (iup.Gauge.init().setNTheme("Hello").unwrap());
    defer item.deinit();
...
test "Gauge DragTypes" {
    ...
    var item = try (iup.Gauge.init().setDragTypes("Hello").unwrap());
    defer item.deinit();
...
test "Gauge WheelDropFocus" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setWheelDropFocus(true).unwrap());
    defer item.deinit();
...
test "Gauge FontStyle" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setFontStyle("Hello").unwrap());
    defer item.deinit();
...
test "Gauge Text" {
    ...
    var item = try (iup.Gauge.init().setText("Hello").unwrap());
    defer item.deinit();
...
test "Gauge Touch" {
    ...
    var item = try (iup.Gauge.init().setTouch(true).unwrap());
    defer item.deinit();
...
test "Gauge DragCursor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Gauge.init().setDragCursor("Hello").unwrap());
    defer item.deinit();
...
test "Gauge Font" {
    ...
    var item = try (iup.Gauge.init().setFont("Hello").unwrap());
    defer item.deinit();
