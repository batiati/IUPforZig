...
pub const Radio = opaque {
    ...
    pub const Initializer = struct {
        ...
        pub fn setValue(self: Initializer, arg: *iup.Toggle) Initializer {
            if (self.last_error) |_| return self;
            interop.setHandleAttribute(self.ref, "VALUE", .{}, arg);
            return self;
        }

        pub fn setValueHandleName(self: Initializer, arg: [:0]const u8) Initializer {
            if (self.last_error) |_| return self;
    ...
    pub fn setValue(self: *Self, arg: *iup.Toggle) void {
        interop.setHandleAttribute(self, "VALUE", .{}, arg);
    }

    pub fn setValueHandleName(self: *Self, arg: [:0]const u8) void {
