...
pub const Radio = opaque {
    ...
    pub const Initializer = struct {
        ...
        pub fn setValueHandle(self: *Initializer, arg: *iup.Toggle) Initializer {
            c.setHandleAttribute(self.ref, "VALUE_HANDLE", arg);
            return self.*;
        }
        ...
        pub fn setValue(self: *Initializer, arg: *iup.Toggle) Initializer {
            c.setHandleAttribute(self.ref, "VALUE", arg);
            return self.*;
        }
    ...
    pub fn getValueHandle(self: *Self) ?*iup.Toggle {
        if (c.getHandleAttribute(self, "VALUE_HANDLE")) |handle| {
    ...
    pub fn setValueHandle(self: *Self, arg: *iup.Toggle) void {
        c.setHandleAttribute(self, "VALUE_HANDLE", arg);
    }
    ...
    pub fn getValue(self: *Self) ?*iup.Toggle {
        if (c.getHandleAttribute(self, "VALUE")) |handle| {
            return @ptrCast(*iup.Toggle, handle);
        } else {
            return null;
        }
    ...
    pub fn setValue(self: *Self, arg: *iup.Toggle) void {
        c.setHandleAttribute(self, "VALUE", arg);
    }
