...
pub const Dial = opaque {
    ...
    pub const Initializer = struct {
        ...
        pub fn setType(self: *Initializer, arg: f64) Initializer {
            c.setDoubleAttribute(self.ref, "TYPE", void, void, arg);
            return self.*;
        }
    ...
    pub fn getType(self: *Self) f64 {
        return c.getDoubleAttribute(self, "TYPE", void, void);
    }

    pub fn setType(self: *Self, arg: f64) void {
        c.setDoubleAttribute(self, "TYPE", void, void, arg);
    }
...
test "Dial TipBalloon" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Dial.init().setTipBalloon(true).unwrap());
    defer item.deinit();
...
test "Dial DrawUsedIRect2d" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Dial.init().setDrawUsedIRect2d(true).unwrap());
    defer item.deinit();
...
test "Dial Cursor" {
    ...
    var item = try (iup.Dial.init().setCursor("Hello").unwrap());
    defer item.deinit();
...
test "Dial DrawAntialias" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Dial.init().setDrawAntialias(42).unwrap());
    defer item.deinit();
...
test "Dial DragCursorCopy" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Dial.init().setDragCursorCopy("Hello").unwrap());
    defer item.deinit();
...
test "Dial HtTransparent" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Dial.init().setHtTransparent(true).unwrap());
    defer item.deinit();
...
test "Dial DragStart" {
    ...
    var item = try (iup.Dial.init().setDragStart(9, 10).unwrap());
    defer item.deinit();
...
test "Dial TipBalloonTitle" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Dial.init().setTipBalloonTitle("Hello").unwrap());
    defer item.deinit();
...
test "Dial ControlId" {
    ...
    var item = try (iup.Dial.init().setControlId(42).unwrap());
    defer item.deinit();
...
test "Dial TipBalloonTitleIcon" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Dial.init().setTipBalloonTitleIcon(true).unwrap());
    defer item.deinit();
...
test "Dial DragCursor" {
    try iup.MainLoop.open();
    defer iup.MainLoop.close();

    var item = try (iup.Dial.init().setDragCursor("Hello").unwrap());
    defer item.deinit();
